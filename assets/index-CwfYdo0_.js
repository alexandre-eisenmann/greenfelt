...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ka,depthTest:!1,depthWrite:!1})}function sR(c,t,n){const a=new Float32Array(mr),r=new lt(0,1,0);return new ga({name:"SphericalGaussianBlur",defines:{n:mr,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${c}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:a},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Pu(),fragmentShader:`
	...
	`}function rR(c){let t=new WeakMap,n=null;function a(f){if(f&&f.isTexture){const p=f.mapping,h=p===qd||p===Xd,g=p===_r||p===Mo;if(h||g){let _=t.get(f);const v=_!==void 0?_.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==v)return n===null&&(n=new I_(c)),_=h?n.fromEquirectangular(f,_):n.fromCubemap(f,_),_.texture.pmremVersion=f.pmremVersion,t.set(f,_),_.texture;if(_!==void 0)return _.texture;{const y=f.image;return h&&y&&y.height>0||g&&y&&r(y)?(n===null&&(n=new I_(c)),_=h?n.fromEquirectangular(f):n.fromCubemap(f),_.texture.pmremVersion=f.pmremVersion,t.set(f,_),f.addEventListener("dispose",o),_.texture):null}}}return f}function r(f){let p=0;const h=6;for(let g=0;g<h;g++)f[g]!==void 0&&p++;return p===h}function o(f){const p=f.target;p.removeEventListener("dispose",o);const h=t.get(p);h!==void 0&&(t.delete(p),h.dispose())}function u(){t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:a,dispose:u}}function oR(c){const t={};function n(a){if(t[a]!==void 0)return t[a];const r=c.getExtension(a);return t[a]=r,r}return{has:function(a){return n(a)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(a){const r=n(a);return r===null&&zl("WebGLRenderer: "+a+" extension not supported."),r}}}function lR(c,t,n,a){const r={},o=new WeakMap;function u(_){const v=_.target;v.index!==null&&t.remove(v.index);for(const M in v.attributes)t.remove(v.attributes[M]);v.removeEventListener("dispose",u),delete r[v.id];const y=o.get(v);y&&(t.remove(y),o.delete(v)),a.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,n.memory.geometries--}function f(_,v){return r[v.id]===!0||(v.addEventListener("dispose",u),r[v.id]=!0,n.memory.geometries++),v}function p(_){const v=_.attributes;for(const y in v)t.update(v[y],c.ARRAY_BUFFER)}function h(_){const v=[],y=_.index,M=_.attributes.position;let b=0;if(y!==null){const T=y.array;b=y.version;for(let U=0,C=T.length;U<C;U+=3){const L=T[U+0],B=T[U+1],P=T[U+2];v.push(L,B,B,P,P,L)}}else if(M!==void 0){const T=M.array;b=M.version;for(let U=0,C=T.length/3-1;U<C;U+=3){const L=U+0,B=U+1,P=U+2;v.push(L,B,B,P,P,L)}}else return;const S=new(Hx(v)?Wx:Xx)(v,1);S.version=b;const x=o.get(_);x&&t.remove(x),o.set(_,S)}function g(_){const v=o.get(_);if(v){const y=_.index;y!==null&&v.version<y.version&&h(_)}else h(_);return o.get(_)}return{get:f,update:p,getWireframeAttribute:g}}function cR(c,t,n){let a;function r(v){a=v}let o,u;function f(v){o=v.type,u=v.bytesPerElement}function p(v,y){c.drawElements(a,y,o,v*u),n.update(y,a,1)}function h(v,y,M){M!==0&&(c.drawElementsInstanced(a,y,o,v*u,M),n.update(y,a,M))}function g(v,y,M){if(M===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(a,y,0,o,v,0,M);let S=0;for(let x=0;x<M;x++)S+=y[x];n.update(S,a,1)}function _(v,y,M,b){if(M===0)return;const S=t.get("WEBGL_multi_draw");if(S===null)for(let x=0;x<v.length;x++)h(v[x]/u,y[x],b[x]);else{S.multiDrawElementsInstancedWEBGL(a,y,0,o,v,0,b,0,M);let x=0;for(let T=0;T<M;T++)x+=y[T]*b[T];n.update(x,a,1)}}this.setMode=r,this.setIndex=f,this.render=p,this.renderInstances=h,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function uR(c){const t={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function a(o,u,f){switch(n.calls++,u){case c.TRIANGLES:n.triangles+=f*(o/3);break;case c.LINES:n.lines+=f*(o/2);break;case c.LINE_STRIP:n.lines+=f*(o-1);break;case c.LINE_LOOP:n.lines+=f*o;break;case c.POINTS:n.points+=f*o;break;default:Ne("WebGLInfo: Unknown draw mode:",u);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:t,render:n,programs:null,autoReset:!0,reset:r,update:a}}function fR(c,t,n){const a=new WeakMap,r=new dn;function o(u,f,p){const h=u.morphTargetInfluences,g=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,_=g!==void 0?g.length:0;let v=a.get(f);if(v===void 0||v.count!==_){let O=function(){q.dispose(),a.delete(f),f.removeEventListener("dispose",O)};var y=O;v!==void 0&&v.texture.dispose();const M=f.morphAttributes.position!==void 0,b=f.morphAttributes.normal!==void 0,S=f.morphAttributes.color!==void 0,x=f.morphAttributes.position||[],T=f.morphAttributes.normal||[],U=f.morphAttributes.color||[];let C=0;M===!0&&(C=1),b===!0&&(C=2),S===!0&&(C=3);let L=f.attributes.position.count*C,B=1;L>t.maxTextureSize&&(B=Math.ceil(L/t.maxTextureSize),L=t.maxTextureSize);const P=new Float32Array(L*B*4*_),q=new Gx(P,L,B,_);q.type=ca,q.needsUpdate=!0;const w=C*4;for(let H=0;H<_;H++){const $=x[H],V=T[H],K=U[H],W=L*B*4*H;for(let z=0;z<$.count;z++){const G=z*w;M===!0&&(r.fromBufferAttribute($,z),P[W+G+0]=r.x,P[W+G+1]=r.y,P[W+G+2]=r.z,P[W+G+3]=0),b===!0&&(r.fromBufferAttribute(V,z),P[W+G+4]=r.x,P[W+G+5]=r.y,P[W+G+6]=r.z,P[W+G+7]=0),S===!0&&(r.fromBufferAttribute(K,z),P[W+G+8]=r.x,P[W+G+9]=r.y,P[W+G+10]=r.z,P[W+G+11]=K.itemSize===4?r.w:1)}}v={count:_,texture:q,size:new Be(L,B)},a.set(f,v),f.addEventListener("dispose",O)}if(u.isInstancedMesh===!0&&u.morphTexture!==null)p.getUniforms().setValue(c,"morphTexture",u.morphTexture,n);else{let M=0;for(let S=0;S<h.length;S++)M+=h[S];const b=f.morphTargetsRelative?1:1-M;p.getUniforms().setValue(c,"morphTargetBaseInfluence",b),p.getUniforms().setValue(c,"morphTargetInfluences",h)}p.getUniforms().setValue(c,"morphTargetsTexture",v.texture,n),p.getUniforms().setValue(c,"morphTargetsTextureSize",v.size)}return{update:o}}function hR(c,t,n,a){let r=new WeakMap;function o(p){const h=a.render.frame,g=p.geometry,_=t.get(p,g);if(r.get(_)!==h&&(t.update(_),r.set(_,h)),p.isInstancedMesh&&(p.hasEventListener("dispose",f)===!1&&p.addEventListener("dispose",f),r.get(p)!==h&&(n.update(p.instanceMatrix,c.ARRAY_BUFFER),p.instanceColor!==null&&n.update(p.instanceColor,c.ARRAY_BUFFER),r.set(p,h))),p.isSkinnedMesh){const v=p.skeleton;r.get(v)!==h&&(v.update(),r.set(v,h))}return _}function u(){r=new WeakMap}function f(p){const h=p.target;h.removeEventListener("dispose",f),n.remove(h.instanceMatrix),h.instanceColor!==null&&n.remove(h.instanceColor)}return{update:o,dispose:u}}const dR={[bx]:"LINEAR_TONE_MAPPING",[Tx]:"REINHARD_TONE_MAPPING",[Ax]:"CINEON_TONE_MAPPING",[wx]:"ACES_FILMIC_TONE_MAPPING",[Cx]:"AGX_TONE_MAPPING",[Dx]:"NEUTRAL_TONE_MAPPING",[Rx]:"CUSTOM_TONE_MAPPING"};function pR(c,t,n,a,r){const o=new ha(t,n,{type:c,depthBuffer:a,stencilBuffer:r}),u=new ha(t,n,{type:$a,depthBuffer:!1,stencilBuffer:!1}),f=new es;f.setAttribute("position",new Ja([-1,3,0,-1,-1,0,3,-1,0],3)),f.setAttribute("uv",new Ja([0,2,0,0,2,0],2));const p=new iT({uniforms:{tDiffuse:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new ji(f,p),g=new zu(-1,1,1,-1,0,1);let _=null,v=null,y=!1,M,b=null,S=[],x=!1;this.setSize=function(T,U){o.setSize(T,U),u.setSize(T,U);for(let C=0;C<S.length;C++){const L=S[C];L.setSize&&L.setSize(T,U)}},this.setEffects=function(T){S=T,x=S.length>0&&S[0].isRenderPass===!0;const U=o.width,C=o.height;for(let L=0;L<S.length;L++){const B=S[L];B.setSize&&B.setSize(U,C)}},this.begin=function(T,U){if(y||T.toneMapping===Yi&&S.length===0)return!1;if(b=U,U!==null){const C=U.width,L=U.height;(o.width!==C||o.height!==L)&&this.setSize(C,L)}return x===!1&&T.setRenderTarget(o),M=T.toneMapping,T.toneMapping=Yi,!0},this.hasRenderPass=function(){return x},this.end=function(T,U){T.toneMapping=M,y=!0;let C=o,L=u;for(let B=0;B<S.length;B++){const P=S[B];if(P.enabled!==!1&&(P.render(T,L,C,U),P.needsSwap!==!1)){const q=C;C=L,L=q}}if(_!==T.outputColorSpace||v!==T.toneMapping){_=T.outputColorSpace,v=T.toneMapping,p.defines={},Ue.getTransfer(_)===Ye&&(p.defines.SRGB_TRANSFER="");const B=dR[v];B&&(p.defines[B]=""),p.needsUpdate=!0}p.uniforms.tDiffuse.value=C.texture,T.setRenderTarget(b),T.render(h,g),b=null,y=!1},this.isCompositing=function(){return y},this.dispose=function(){o.dispose(),u.dispose(),f.dispose(),p.dispose()}}const ty=new qn,Rp=new Pl(1,1),ey=new Gx,ny=new L1,iy=new Zx,k_=[],q_=[],X_=new Float32Array(16),W_=new Float32Array(9),Y_=new Float32Array(4);function Ro(c,t,n){const a=c[0];if(a<=0||a>0)return c;const r=t*n;let o=k_[r];if(o===void 0&&(o=new Float32Array(r),k_[r]=o),t!==0){a.toArray(o,0);for(let u=1,f=0;u!==t;++u)f+=n,c[u].toArray(o,f)}return o}function Tn(c,t){if(c.length!==t.length)return!1;for(let n=0,a=c.length;n<a;n++)if(c[n]!==t[n])return!1;return!0}function An(c,t){for(let n=0,a=t.length;n<a;n++)c[n]=t[n]}function Bu(c,t){let n=q_[t];n===void 0&&(n=new Int32Array(t),q_[t]=n);for(let a=0;a!==t;++a)n[a]=c.allocateTextureUnit();return n}function mR(c,t){const n=this.cache;n[0]!==t&&(c.uniform1f(this.addr,t),n[0]=t)}function gR(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(c.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Tn(n,t))return;c.uniform2fv(this.addr,t),An(n,t)}}function vR(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(c.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(c.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(Tn(n,t))return;c.uniform3fv(this.addr,t),An(n,t)}}function _R(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(c.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Tn(n,t))return;c.uniform4fv(this.addr,t),An(n,t)}}function xR(c,t){const n=this.cache,a=t.elements;if(a===void 0){if(Tn(n,t))return;c.uniformMatrix2fv(this.addr,!1,t),An(n,t)}else{if(Tn(n,a))return;Y_.set(a),c.uniformMatrix2fv(this.addr,!1,Y_),An(n,a)}}function yR(c,t){const n=this.cache,a=t.elements;if(a===void 0){if(Tn(n,t))return;c.uniformMatrix3fv(this.addr,!1,t),An(n,t)}else{if(Tn(n,a))return;W_.set(a),c.uniformMatrix3fv(this.addr,!1,W_),An(n,a)}}function SR(c,t){const n=this.cache,a=t.elements;if(a===void 0){if(Tn(n,t))return;c.uniformMatrix4fv(this.addr,!1,t),An(n,t)}else{if(Tn(n,a))return;X_.set(a),c.uniformMatrix4fv(this.addr,!1,X_),An(n,a)}}function MR(c,t){const n=this.cache;n[0]!==t&&(c.uniform1i(this.addr,t),n[0]=t)}function ER(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(c.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Tn(n,t))return;c.uniform2iv(this.addr,t),An(n,t)}}function bR(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(c.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(Tn(n,t))return;c.uniform3iv(this.addr,t),An(n,t)}}function TR(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(c.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Tn(n,t))return;c.uniform4iv(this.addr,t),An(n,t)}}function AR(c,t){const n=this.cache;n[0]!==t&&(c.uniform1ui(this.addr,t),n[0]=t)}function wR(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(c.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Tn(n,t))return;c.uniform2uiv(this.addr,t),An(n,t)}}function RR(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(c.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(Tn(n,t))return;c.uniform3uiv(this.addr,t),An(n,t)}}function CR(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(c.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Tn(n,t))return;c.uniform4uiv(this.addr,t),An(n,t)}}function DR(c,t,n){const a=this.cache,r=n.allocateTextureUnit();a[0]!==r&&(c.uniform1i(this.addr,r),a[0]=r);let o;this.type===c.SAMPLER_2D_SHADOW?(Rp.compareFunction=n.isReversedDepthBuffer()?Vp:Gp,o=Rp):o=ty,n.setTexture2D(t||o,r)}function NR(c,t,n){const a=this.cache,r=n.allocateTextureUnit();a[0]!==r&&(c.uniform1i(this.addr,r),a[0]=r),n.setTexture3D(t||ny,r)}function UR(c,t,n){const a=this.cache,r=n.allocateTextureUnit();a[0]!==r&&(c.uniform1i(this.addr,r),a[0]=r),n.setTextureCube(t||iy,r)}function LR(c,t,n){const a=this.cache,r=n.allocateTextureUnit();a[0]!==r&&(c.uniform1i(this.addr,r),a[0]=r),n.setTexture2DArray(t||ey,r)}function OR(c){switch(c){case 5126:return mR;case 35664:return gR;case 35665:return vR;case 35666:return _R;case 35674:return xR;case 35675:return yR;case 35676:return SR;case 5124:case 35670:return MR;case 35667:case 35671:return ER;case 35668:case 35672:return bR;case 35669:case 35673:return TR;case 5125:return AR;case 36294:return wR;case 36295:return RR;case 36296:return CR;case 35678:case 36198:case 36298:case 36306:case 35682:return DR;case 35679:case 36299:case 36307:return NR;case 35680:case 36300:case 36308:case 36293:return UR;case 36289:case 36303:case 36311:case 36292:return LR}}function zR(c,t){c.uniform1fv(this.addr,t)}function PR(c,t){const n=Ro(t,this.size,2);c.uniform2fv(this.addr,n)}function BR(c,t){const n=Ro(t,this.size,3);c.uniform3fv(this.addr,n)}function FR(c,t){const n=Ro(t,this.size,4);c.uniform4fv(this.addr,n)}function IR(c,t){const n=Ro(t,this.size,4);c.uniformMatrix2fv(this.addr,!1,n)}function HR(c,t){const n=Ro(t,this.size,9);c.uniformMatrix3fv(this.addr,!1,n)}function GR(c,t){const n=Ro(t,this.size,16);c.uniformMatrix4fv(this.addr,!1,n)}function VR(c,t){c.uniform1iv(this.addr,t)}function kR(c,t){c.uniform2iv(this.addr,t)}function qR(c,t){c.uniform3iv(this.addr,t)}function XR(c,t){c.uniform4iv(this.addr,t)}function WR(c,t){c.uniform1uiv(this.addr,t)}function YR(c,t){c.uniform2uiv(this.addr,t)}function jR(c,t){c.uniform3uiv(this.addr,t)}function ZR(c,t){c.uniform4uiv(this.addr,t)}function KR(c,t,n){const a=this.cache,r=t.length,o=Bu(n,r);Tn(a,o)||(c.uniform1iv(this.addr,o),An(a,o));let u;this.type===c.SAMPLER_2D_SHADOW?u=Rp:u=ty;for(let f=0;f!==r;++f)n.setTexture2D(t[f]||u,o[f])}function QR(c,t,n){const a=this.cache,r=t.length,o=Bu(n,r);Tn(a,o)||(c.uniform1iv(this.addr,o),An(a,o));for(let u=0;u!==r;++u)n.setTexture3D(t[u]||ny,o[u])}function JR(c,t,n){const a=this.cache,r=t.length,o=Bu(n,r);Tn(a,o)||(c.uniform1iv(this.addr,o),An(a,o));for(let u=0;u!==r;++u)n.setTextureCube(t[u]||iy,o[u])}function $R(c,t,n){const a=this.cache,r=t.length,o=Bu(n,r);Tn(a,o)||(c.uniform1iv(this.addr,o),An(a,o));for(let u=0;u!==r;++u)n.setTexture2DArray(t[u]||ey,o[u])}function tC(c){switch(c){case 5126:return zR;case 35664:return PR;case 35665:return BR;case 35666:return FR;case 35674:return IR;case 35675:return HR;case 35676:return GR;case 5124:case 35670:return VR;case 35667:case 35671:return kR;case 35668:case 35672:return qR;case 35669:case 35673:return XR;case 5125:return WR;case 36294:return YR;case 36295:return jR;case 36296:return ZR;case 35678:case 36198:case 36298:case 36306:case 35682:return KR;case 35679:case 36299:case 36307:return QR;case 35680:case 36300:case 36308:case 36293:return JR;case 36289:case 36303:case 36311:case 36292:return $R}}class eC{constructor(t,n,a){this.id=t,this.addr=a,this.cache=[],this.type=n.type,this.setValue=OR(n.type)}}class nC{constructor(t,n,a){this.id=t,this.addr=a,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=tC(n.type)}}class iC{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,n,a){const r=this.seq;for(let o=0,u=r.length;o!==u;++o){const f=r[o];f.setValue(t,n[f.id],a)}}}const Dd=/(\w+)(\])?(\[|\.)?/g;function j_(c,t){c.seq.push(t),c.map[t.id]=t}function aC(c,t,n){const a=c.name,r=a.length;for(Dd.lastIndex=0;;){const o=Dd.exec(a),u=Dd.lastIndex;let f=o[1];const p=o[2]==="]",h=o[3];if(p&&(f=f|0),h===void 0||h==="["&&u+2===r){j_(n,h===void 0?new eC(f,c,t):new nC(f,c,t));break}else{let _=n.map[f];_===void 0&&(_=new iC(f),j_(n,_)),n=_}}}class Ru{constructor(t,n){this.seq=[],this.map={};const a=t.getProgramParameter(n,t.ACTIVE_UNIFORMS);for(let u=0;u<a;++u){const f=t.getActiveUniform(n,u),p=t.getUniformLocation(n,f.name);aC(f,p,this)}const r=[],o=[];for(const u of this.seq)u.type===t.SAMPLER_2D_SHADOW||u.type===t.SAMPLER_CUBE_SHADOW||u.type===t.SAMPLER_2D_ARRAY_SHADOW?r.push(u):o.push(u);r.length>0&&(this.seq=r.concat(o))}setValue(t,n,a,r){const o=this.map[n];o!==void 0&&o.setValue(t,a,r)}setOptional(t,n,a){const r=n[a];r!==void 0&&this.setValue(t,a,r)}static upload(t,n,a,r){for(let o=0,u=n.length;o!==u;++o){const f=n[o],p=a[f.id];p.needsUpdate!==!1&&f.setValue(t,p.value,r)}}static seqWithValue(t,n){const a=[];for(let r=0,o=t.length;r!==o;++r){const u=t[r];u.id in n&&a.push(u)}return a}}function Z_(c,t,n){const a=c.createShader(t);return c.shaderSource(a,n),c.compileShader(a),a}const sC=37297;let rC=0;function oC(c,t){const n=c.split(`
`),a=[],r=Math.max(t-6,0),o=Math.min(t+6,n.length);for(let u=r;u<o;u++){const f=u+1;a.push(`${f===t?">":" "} ${f}: ${n[u]}`)}return a.join(`
`)}const K_=new _e;function lC(c){Ue._getMatrix(K_,Ue.workingColorSpace,c);const t=`mat3( ${K_.elements.map(n=>n.toFixed(4))} )`;switch(Ue.getTransfer(c)){case Nu:return[t,"LinearTransferOETF"];case Ye:return[t,"sRGBTransferOETF"];default:return pe("WebGLProgram: Unsupported color space: ",c),[t,"LinearTransferOETF"]}}function Q_(c,t,n){const a=c.getShaderParameter(t,c.COMPILE_STATUS),o=(c.getShaderInfoLog(t)||"").trim();if(a&&o==="")return"";const u=/ERROR: 0:(\d+)/.exec(o);if(u){const f=parseInt(u[1]);return n.toUpperCase()+`
...
}`;class e2{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){const a=new Qx(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=a}}getMesh(t){if(this.texture!==null&&this.mesh===null){const n=t.cameras[0].viewport,a=new ga({vertexShader:$C,fragmentShader:t2,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new ji(new Gl(20,20),a)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class n2 extends Ao{constructor(t,n){super();const a=this;let r=null,o=1,u=null,f="local-floor",p=1,h=null,g=null,_=null,v=null,y=null,M=null;const b=typeof XRWebGLBinding<"u",S=new e2,x={},T=n.getContextAttributes();let U=null,C=null;const L=[],B=[],P=new Be;let q=null;const w=new ki;w.viewport=new dn;const O=new ki;O.viewport=new dn;const H=[w,O],$=new uT;let V=null,K=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(nt){let gt=L[nt];return gt===void 0&&(gt=new Ed,L[nt]=gt),gt.getTargetRaySpace()},this.getControllerGrip=function(nt){let gt=L[nt];return gt===void 0&&(gt=new Ed,L[nt]=gt),gt.getGripSpace()},this.getHand=function(nt){let gt=L[nt];return gt===void 0&&(gt=new Ed,L[nt]=gt),gt.getHandSpace()};function W(nt){const gt=B.indexOf(nt.inputSource);if(gt===-1)return;const Ct=L[gt];Ct!==void 0&&(Ct.update(nt.inputSource,nt.frame,h||u),Ct.dispatchEvent({type:nt.type,data:nt.inputSource}))}function z(){r.removeEventListener("select",W),r.removeEventListener("selectstart",W),r.removeEventListener("selectend",W),r.removeEventListener("squeeze",W),r.removeEventListener("squeezestart",W),r.removeEventListener("squeezeend",W),r.removeEventListener("end",z),r.removeEventListener("inputsourceschange",G);for(let nt=0;nt<L.length;nt++){const gt=B[nt];gt!==null&&(B[nt]=null,L[nt].disconnect(gt))}V=null,K=null,S.reset();for(const nt in x)delete x[nt];t.setRenderTarget(U),y=null,v=null,_=null,r=null,C=null,Dt.stop(),a.isPresenting=!1,t.setPixelRatio(q),t.setSize(P.width,P.height,!1),a.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(nt){o=nt,a.isPresenting===!0&&pe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(nt){f=nt,a.isPresenting===!0&&pe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return h||u},this.setReferenceSpace=function(nt){h=nt},this.getBaseLayer=function(){return v!==null?v:y},this.getBinding=function(){return _===null&&b&&(_=new XRWebGLBinding(r,n)),_},this.getFrame=function(){return M},this.getSession=function(){return r},this.setSession=async function(nt){if(r=nt,r!==null){if(U=t.getRenderTarget(),r.addEventListener("select",W),r.addEventListener("selectstart",W),r.addEventListener("selectend",W),r.addEventListener("squeeze",W),r.addEventListener("squeezestart",W),r.addEventListener("squeezeend",W),r.addEventListener("end",z),r.addEventListener("inputsourceschange",G),T.xrCompatible!==!0&&await n.makeXRCompatible(),q=t.getPixelRatio(),t.getSize(P),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ct=null,Pt=null,Nt=null;T.depth&&(Nt=T.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,Ct=T.stencil?vr:ts,Pt=T.stencil?Ol:pa);const ye={colorFormat:n.RGBA8,depthFormat:Nt,scaleFactor:o};_=this.getBinding(),v=_.createProjectionLayer(ye),r.updateRenderState({layers:[v]}),t.setPixelRatio(1),t.setSize(v.textureWidth,v.textureHeight,!1),C=new ha(v.textureWidth,v.textureHeight,{format:Wi,type:Si,depthTexture:new Pl(v.textureWidth,v.textureHeight,Pt,void 0,void 0,void 0,void 0,void 0,void 0,Ct),stencilBuffer:T.stencil,colorSpace:t.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const Ct={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:o};y=new XRWebGLLayer(r,n,Ct),r.updateRenderState({baseLayer:y}),t.setPixelRatio(1),t.setSize(y.framebufferWidth,y.framebufferHeight,!1),C=new ha(y.framebufferWidth,y.framebufferHeight,{format:Wi,type:Si,colorSpace:t.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}C.isXRRenderTarget=!0,this.setFoveation(p),h=null,u=await r.requestReferenceSpace(f),Dt.setContext(r),Dt.start(),a.isPresenting=!0,a.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return S.getDepthTexture()};function G(nt){for(let gt=0;gt<nt.removed.length;gt++){const Ct=nt.removed[gt],Pt=B.indexOf(Ct);Pt>=0&&(B[Pt]=null,L[Pt].disconnect(Ct))}for(let gt=0;gt<nt.added.length;gt++){const Ct=nt.added[gt];let Pt=B.indexOf(Ct);if(Pt===-1){for(let ye=0;ye<L.length;ye++)if(ye>=B.length){B.push(Ct),Pt=ye;break}else if(B[ye]===null){B[ye]=Ct,Pt=ye;break}if(Pt===-1)break}const Nt=L[Pt];Nt&&Nt.connect(Ct)}}const Q=new lt,mt=new lt;function yt(nt,gt,Ct){Q.setFromMatrixPosition(gt.matrixWorld),mt.setFromMatrixPosition(Ct.matrixWorld);const Pt=Q.distanceTo(mt),Nt=gt.projectionMatrix.elements,ye=Ct.projectionMatrix.elements,De=Nt[14]/(Nt[10]-1),ue=Nt[14]/(Nt[10]+1),ie=(Nt[9]+1)/Nt[5],be=(Nt[9]-1)/Nt[5],ce=(Nt[8]-1)/Nt[0],en=(ye[8]+1)/ye[0],X=De*ce,je=De*en,Se=Pt/(-ce+en),fe=Se*-ce;if(gt.matrixWorld.decompose(nt.position,nt.quaternion,nt.scale),nt.translateX(fe),nt.translateZ(Se),nt.matrixWorld.compose(nt.position,nt.quaternion,nt.scale),nt.matrixWorldInverse.copy(nt.matrixWorld).invert(),Nt[10]===-1)nt.projectionMatrix.copy(gt.projectionMatrix),nt.projectionMatrixInverse.copy(gt.projectionMatrixInverse);else{const qt=De+Se,I=ue+Se,A=X-fe,J=je+(Pt-fe),_t=ie*ue/I*qt,Et=be*ue/I*qt;nt.projectionMatrix.makePerspective(A,J,_t,Et,qt,I),nt.projectionMatrixInverse.copy(nt.projectionMatrix).invert()}}function F(nt,gt){gt===null?nt.matrixWorld.copy(nt.matrix):nt.matrixWorld.multiplyMatrices(gt.matrixWorld,nt.matrix),nt.matrixWorldInverse.copy(nt.matrixWorld).invert()}this.updateCamera=function(nt){if(r===null)return;let gt=nt.near,Ct=nt.far;S.texture!==null&&(S.depthNear>0&&(gt=S.depthNear),S.depthFar>0&&(Ct=S.depthFar)),$.near=O.near=w.near=gt,$.far=O.far=w.far=Ct,(V!==$.near||K!==$.far)&&(r.updateRenderState({depthNear:$.near,depthFar:$.far}),V=$.near,K=$.far),$.layers.mask=nt.layers.mask|6,w.layers.mask=$.layers.mask&3,O.layers.mask=$.layers.mask&5;const Pt=nt.parent,Nt=$.cameras;F($,Pt);for(let ye=0;ye<Nt.length;ye++)F(Nt[ye],Pt);Nt.length===2?yt($,w,O):$.projectionMatrix.copy(w.projectionMatrix),j(nt,$,Pt)};function j(nt,gt,Ct){Ct===null?nt.matrix.copy(gt.matrixWorld):(nt.matrix.copy(Ct.matrixWorld),nt.matrix.invert(),nt.matrix.multiply(gt.matrixWorld)),nt.matrix.decompose(nt.position,nt.quaternion,nt.scale),nt.updateMatrixWorld(!0),nt.projectionMatrix.copy(gt.projectionMatrix),nt.projectionMatrixInverse.copy(gt.projectionMatrixInverse),nt.isPerspectiveCamera&&(nt.fov=Ap*2*Math.atan(1/nt.projectionMatrix.elements[5]),nt.zoom=1)}this.getCamera=function(){return $},this.getFoveation=function(){if(!(v===null&&y===null))return p},this.setFoveation=function(nt){p=nt,v!==null&&(v.fixedFoveation=nt),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=nt)},this.hasDepthSensing=function(){return S.texture!==null},this.getDepthSensingMesh=function(){return S.getMesh($)},this.getCameraTexture=function(nt){return x[nt]};let ct=null;function Tt(nt,gt){if(g=gt.getViewerPose(h||u),M=gt,g!==null){const Ct=g.views;y!==null&&(t.setRenderTargetFramebuffer(C,y.framebuffer),t.setRenderTarget(C));let Pt=!1;Ct.length!==$.cameras.length&&($.cameras.length=0,Pt=!0);for(let ue=0;ue<Ct.length;ue++){const ie=Ct[ue];let be=null;if(y!==null)be=y.getViewport(ie);else{const en=_.getViewSubImage(v,ie);be=en.viewport,ue===0&&(t.setRenderTargetTextures(C,en.colorTexture,en.depthStencilTexture),t.setRenderTarget(C))}let ce=H[ue];ce===void 0&&(ce=new ki,ce.layers.enable(ue),ce.viewport=new dn,H[ue]=ce),ce.matrix.fromArray(ie.transform.matrix),ce.matrix.decompose(ce.position,ce.quaternion,ce.scale),ce.projectionMatrix.fromArray(ie.projectionMatrix),ce.projectionMatrixInverse.copy(ce.projectionMatrix).invert(),ce.viewport.set(be.x,be.y,be.width,be.height),ue===0&&($.matrix.copy(ce.matrix),$.matrix.decompose($.position,$.quaternion,$.scale)),Pt===!0&&$.cameras.push(ce)}const Nt=r.enabledFeatures;if(Nt&&Nt.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&b){_=a.getBinding();const ue=_.getDepthInformation(Ct[0]);ue&&ue.isValid&&ue.texture&&S.init(ue,r.renderState)}if(Nt&&Nt.includes("camera-access")&&b){t.state.unbindTexture(),_=a.getBinding();for(let ue=0;ue<Ct.length;ue++){const ie=Ct[ue].camera;if(ie){let be=x[ie];be||(be=new Qx,x[ie]=be);const ce=_.getCameraImage(ie);be.sourceTexture=ce}}}}for(let Ct=0;Ct<L.length;Ct++){const Pt=B[Ct],Nt=L[Ct];Pt!==null&&Nt!==void 0&&Nt.update(Pt,gt,h||u)}ct&&ct(nt,gt),gt.detectedPlanes&&a.dispatchEvent({type:"planesdetected",data:gt}),M=null}const Dt=new $x;Dt.setAnimationLoop(Tt),this.setAnimationLoop=function(nt){ct=nt},this.dispose=function(){}}}const lr=new ma,i2=new cn;function a2(c,t){function n(S,x){S.matrixAutoUpdate===!0&&S.updateMatrix(),x.value.copy(S.matrix)}function a(S,x){x.color.getRGB(S.fogColor.value,Yx(c)),x.isFog?(S.fogNear.value=x.near,S.fogFar.value=x.far):x.isFogExp2&&(S.fogDensity.value=x.density)}function r(S,x,T,U,C){x.isMeshBasicMaterial||x.isMeshLambertMaterial?o(S,x):x.isMeshToonMaterial?(o(S,x),_(S,x)):x.isMeshPhongMaterial?(o(S,x),g(S,x)):x.isMeshStandardMaterial?(o(S,x),v(S,x),x.isMeshPhysicalMaterial&&y(S,x,C)):x.isMeshMatcapMaterial?(o(S,x),M(S,x)):x.isMeshDepthMaterial?o(S,x):x.isMeshDistanceMaterial?(o(S,x),b(S,x)):x.isMeshNormalMaterial?o(S,x):x.isLineBasicMaterial?(u(S,x),x.isLineDashedMaterial&&f(S,x)):x.isPointsMaterial?p(S,x,T,U):x.isSpriteMaterial?h(S,x):x.isShadowMaterial?(S.color.value.copy(x.color),S.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function o(S,x){S.opacity.value=x.opacity,x.color&&S.diffuse.value.copy(x.color),x.emissive&&S.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(S.map.value=x.map,n(x.map,S.mapTransform)),x.alphaMap&&(S.alphaMap.value=x.alphaMap,n(x.alphaMap,S.alphaMapTransform)),x.bumpMap&&(S.bumpMap.value=x.bumpMap,n(x.bumpMap,S.bumpMapTransform),S.bumpScale.value=x.bumpScale,x.side===ri&&(S.bumpScale.value*=-1)),x.normalMap&&(S.normalMap.value=x.normalMap,n(x.normalMap,S.normalMapTransform),S.normalScale.value.copy(x.normalScale),x.side===ri&&S.normalScale.value.negate()),x.displacementMap&&(S.displacementMap.value=x.displacementMap,n(x.displacementMap,S.displacementMapTransform),S.displacementScale.value=x.displacementScale,S.displacementBias.value=x.displacementBias),x.emissiveMap&&(S.emissiveMap.value=x.emissiveMap,n(x.emissiveMap,S.emissiveMapTransform)),x.specularMap&&(S.specularMap.value=x.specularMap,n(x.specularMap,S.specularMapTransform)),x.alphaTest>0&&(S.alphaTest.value=x.alphaTest);const T=t.get(x),U=T.envMap,C=T.envMapRotation;U&&(S.envMap.value=U,lr.copy(C),lr.x*=-1,lr.y*=-1,lr.z*=-1,U.isCubeTexture&&U.isRenderTargetTexture===!1&&(lr.y*=-1,lr.z*=-1),S.envMapRotation.value.setFromMatrix4(i2.makeRotationFromEuler(lr)),S.flipEnvMap.value=U.isCubeTexture&&U.isRenderTargetTexture===!1?-1:1,S.reflectivity.value=x.reflectivity,S.ior.value=x.ior,S.refractionRatio.value=x.refractionRatio),x.lightMap&&(S.lightMap.value=x.lightMap,S.lightMapIntensity.value=x.lightMapIntensity,n(x.lightMap,S.lightMapTransform)),x.aoMap&&(S.aoMap.value=x.aoMap,S.aoMapIntensity.value=x.aoMapIntensity,n(x.aoMap,S.aoMapTransform))}function u(S,x){S.diffuse.value.copy(x.color),S.opacity.value=x.opacity,x.map&&(S.map.value=x.map,n(x.map,S.mapTransform))}function f(S,x){S.dashSize.value=x.dashSize,S.totalSize.value=x.dashSize+x.gapSize,S.scale.value=x.scale}function p(S,x,T,U){S.diffuse.value.copy(x.color),S.opacity.value=x.opacity,S.size.value=x.size*T,S.scale.value=U*.5,x.map&&(S.map.value=x.map,n(x.map,S.uvTransform)),x.alphaMap&&(S.alphaMap.value=x.alphaMap,n(x.alphaMap,S.alphaMapTransform)),x.alphaTest>0&&(S.alphaTest.value=x.alphaTest)}function h(S,x){S.diffuse.value.copy(x.color),S.opacity.value=x.opacity,S.rotation.value=x.rotation,x.map&&(S.map.value=x.map,n(x.map,S.mapTransform)),x.alphaMap&&(S.alphaMap.value=x.alphaMap,n(x.alphaMap,S.alphaMapTransform)),x.alphaTest>0&&(S.alphaTest.value=x.alphaTest)}function g(S,x){S.specular.value.copy(x.specular),S.shininess.value=Math.max(x.shininess,1e-4)}function _(S,x){x.gradientMap&&(S.gradientMap.value=x.gradientMap)}function v(S,x){S.metalness.value=x.metalness,x.metalnessMap&&(S.metalnessMap.value=x.metalnessMap,n(x.metalnessMap,S.metalnessMapTransform)),S.roughness.value=x.roughness,x.roughnessMap&&(S.roughnessMap.value=x.roughnessMap,n(x.roughnessMap,S.roughnessMapTransform)),x.envMap&&(S.envMapIntensity.value=x.envMapIntensity)}function y(S,x,T){S.ior.value=x.ior,x.sheen>0&&(S.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),S.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(S.sheenColorMap.value=x.sheenColorMap,n(x.sheenColorMap,S.sheenColorMapTransform)),x.sheenRoughnessMap&&(S.sheenRoughnessMap.value=x.sheenRoughnessMap,n(x.sheenRoughnessMap,S.sheenRoughnessMapTransform))),x.clearcoat>0&&(S.clearcoat.value=x.clearcoat,S.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(S.clearcoatMap.value=x.clearcoatMap,n(x.clearcoatMap,S.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(S.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,n(x.clearcoatRoughnessMap,S.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(S.clearcoatNormalMap.value=x.clearcoatNormalMap,n(x.clearcoatNormalMap,S.clearcoatNormalMapTransform),S.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===ri&&S.clearcoatNormalScale.value.negate())),x.dispersion>0&&(S.dispersion.value=x.dispersion),x.iridescence>0&&(S.iridescence.value=x.iridescence,S.iridescenceIOR.value=x.iridescenceIOR,S.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],S.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(S.iridescenceMap.value=x.iridescenceMap,n(x.iridescenceMap,S.iridescenceMapTransform)),x.iridescenceThicknessMap&&(S.iridescenceThicknessMap.value=x.iridescenceThicknessMap,n(x.iridescenceThicknessMap,S.iridescenceThicknessMapTransform))),x.transmission>0&&(S.transmission.value=x.transmission,S.transmissionSamplerMap.value=T.texture,S.transmissionSamplerSize.value.set(T.width,T.height),x.transmissionMap&&(S.transmissionMap.value=x.transmissionMap,n(x.transmissionMap,S.transmissionMapTransform)),S.thickness.value=x.thickness,x.thicknessMap&&(S.thicknessMap.value=x.thicknessMap,n(x.thicknessMap,S.thicknessMapTransform)),S.attenuationDistance.value=x.attenuationDistance,S.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(S.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(S.anisotropyMap.value=x.anisotropyMap,n(x.anisotropyMap,S.anisotropyMapTransform))),S.specularIntensity.value=x.specularIntensity,S.specularColor.value.copy(x.specularColor),x.specularColorMap&&(S.specularColorMap.value=x.specularColorMap,n(x.specularColorMap,S.specularColorMapTransform)),x.specularIntensityMap&&(S.specularIntensityMap.value=x.specularIntensityMap,n(x.specularIntensityMap,S.specularIntensityMapTransform))}function M(S,x){x.matcap&&(S.matcap.value=x.matcap)}function b(S,x){const T=t.get(x).light;S.referencePosition.value.setFromMatrixPosition(T.matrixWorld),S.nearDistance.value=T.shadow.camera.near,S.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:a,refreshMaterialUniforms:r}}function s2(c,t,n,a){let r={},o={},u=[];const f=c.getParameter(c.MAX_UNIFORM_BUFFER_BINDINGS);function p(T,U){const C=U.program;a.uniformBlockBinding(T,C)}function h(T,U){let C=r[T.id];C===void 0&&(M(T),C=g(T),r[T.id]=C,T.addEventListener("dispose",S));const L=U.program;a.updateUBOMapping(T,L);const B=t.render.frame;o[T.id]!==B&&(v(T),o[T.id]=B)}function g(T){const U=_();T.__bindingPointIndex=U;const C=c.createBuffer(),L=T.__size,B=T.usage;return c.bindBuffer(c.UNIFORM_BUFFER,C),c.bufferData(c.UNIFORM_BUFFER,L,B),c.bindBuffer(c.UNIFORM_BUFFER,null),c.bindBufferBase(c.UNIFORM_BUFFER,U,C),C}function _(){for(let T=0;T<f;T++)if(u.indexOf(T)===-1)return u.push(T),T;return Ne("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(T){const U=r[T.id],C=T.uniforms,L=T.__cache;c.bindBuffer(c.UNIFORM_BUFFER,U);for(let B=0,P=C.length;B<P;B++){const q=Array.isArray(C[B])?C[B]:[C[B]];for(let w=0,O=q.length;w<O;w++){const H=q[w];if(y(H,B,w,L)===!0){const $=H.__offset,V=Array.isArray(H.value)?H.value:[H.value];let K=0;for(let W=0;W<V.length;W++){const z=V[W],G=b(z);typeof z=="number"||typeof z=="boolean"?(H.__data[0]=z,c.bufferSubData(c.UNIFORM_BUFFER,$+K,H.__data)):z.isMatrix3?(H.__data[0]=z.elements[0],H.__data[1]=z.elements[1],H.__data[2]=z.elements[2],H.__data[3]=0,H.__data[4]=z.elements[3],H.__data[5]=z.elements[4],H.__data[6]=z.elements[5],H.__data[7]=0,H.__data[8]=z.elements[6],H.__data[9]=z.elements[7],H.__data[10]=z.elements[8],H.__data[11]=0):(z.toArray(H.__data,K),K+=G.storage/Float32Array.BYTES_PER_ELEMENT)}c.bufferSubData(c.UNIFORM_BUFFER,$,H.__data)}}}c.bindBuffer(c.UNIFORM_BUFFER,null)}function y(T,U,C,L){const B=T.value,P=U+"_"+C;if(L[P]===void 0)return typeof B=="number"||typeof B=="boolean"?L[P]=B:L[P]=B.clone(),!0;{const q=L[P];if(typeof B=="number"||typeof B=="boolean"){if(q!==B)return L[P]=B,!0}else if(q.equals(B)===!1)return q.copy(B),!0}return!1}function M(T){const U=T.uniforms;let C=0;const L=16;for(let P=0,q=U.length;P<q;P++){const w=Array.isArray(U[P])?U[P]:[U[P]];for(let O=0,H=w.length;O<H;O++){const $=w[O],V=Array.isArray($.value)?$.value:[$.value];for(let K=0,W=V.length;K<W;K++){const z=V[K],G=b(z),Q=C%L,mt=Q%G.boundary,yt=Q+mt;C+=mt,yt!==0&&L-yt<G.storage&&(C+=L-yt),$.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=C,C+=G.storage}}}const B=C%L;return B>0&&(C+=L-B),T.__size=C,T.__cache={},this}function b(T){const U={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(U.boundary=4,U.storage=4):T.isVector2?(U.boundary=8,U.storage=8):T.isVector3||T.isColor?(U.boundary=16,U.storage=12):T.isVector4?(U.boundary=16,U.storage=16):T.isMatrix3?(U.boundary=48,U.storage=48):T.isMatrix4?(U.boundary=64,U.storage=64):T.isTexture?pe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):pe("WebGLRenderer: Unsupported uniform value type.",T),U}function S(T){const U=T.target;U.removeEventListener("dispose",S);const C=u.indexOf(U.__bindingPointIndex);u.splice(C,1),c.deleteBuffer(r[U.id]),delete r[U.id],delete o[U.id]}function x(){for(const T in r)c.deleteBuffer(r[T]);u=[],r={},o={}}return{bind:p,update:h,dispose:x}}const r2=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ra=null;function o2(){return ra===null&&(ra=new J1(r2,16,16,Eo,$a),ra.name="DFG_LUT",ra.minFilter=In,ra.magFilter=In,ra.wrapS=Za,ra.wrapT=Za,ra.generateMipmaps=!1,ra.needsUpdate=!0),ra}class l2{constructor(t={}){const{canvas:n=T1(),context:a=null,depth:r=!0,stencil:o=!1,alpha:u=!1,antialias:f=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:h=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reversedDepthBuffer:v=!1,outputBufferType:y=Si}=t;this.isWebGLRenderer=!0;let M;if(a!==null){if(typeof WebGLRenderingContext<"u"&&a instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");M=a.getContextAttributes().alpha}else M=u;const b=y,S=new Set([Hp,Ip,Fp]),x=new Set([Si,pa,Ll,Ol,Pp,Bp]),T=new Uint32Array(4),U=new Int32Array(4);let C=null,L=null;const B=[],P=[];let q=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Yi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const w=this;let O=!1;this._outputColorSpace=jn;let H=0,$=0,V=null,K=-1,W=null;const z=new dn,G=new dn;let Q=null;const mt=new Pe(0);let yt=0,F=n.width,j=n.height,ct=1,Tt=null,Dt=null;const nt=new dn(0,0,F,j),gt=new dn(0,0,F,j);let Ct=!1;const Pt=new Wp;let Nt=!1,ye=!1;const De=new cn,ue=new lt,ie=new dn,be={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ce=!1;function en(){return V===null?ct:1}let X=a;function je(N,tt){return n.getContext(N,tt)}try{const N={alpha:!0,depth:r,stencil:o,antialias:f,premultipliedAlpha:p,preserveDrawingBuffer:h,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Op}`),n.addEventListener("webglcontextlost",Qt,!1),n.addEventListener("webglcontextrestored",Xt,!1),n.addEventListener("webglcontextcreationerror",le,!1),X===null){const tt="webgl2";if(X=je(tt,N),X===null)throw je(tt)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(N){throw Ne("WebGLRenderer: "+N.message),N}let Se,fe,qt,I,A,J,_t,Et,ht,Wt,Ut,Yt,se,At,wt,Gt,Ft,Lt,me,Z,Ot,Rt,pt,ut;function vt(){Se=new oR(X),Se.init(),Rt=new JC(X,Se),fe=new Jw(X,Se,t,Rt),qt=new KC(X,Se),fe.reversedDepthBuffer&&v&&qt.buffers.depth.setReversed(!0),I=new uR(X),A=new zC,J=new QC(X,Se,qt,A,fe,Rt,I),_t=new tR(w),Et=new rR(w),ht=new pT(X),pt=new Kw(X,ht),Wt=new lR(X,ht,I,pt),Ut=new hR(X,Wt,ht,I),me=new fR(X,fe,J),Gt=new $w(A),Yt=new OC(w,_t,Et,Se,fe,pt,Gt),se=new a2(w,A),At=new BC,wt=new kC(Se),Lt=new Zw(w,_t,Et,qt,Ut,M,p),Ft=new jC(w,Ut,fe),ut=new s2(X,I,fe,qt),Z=new Qw(X,Se,I),Ot=new cR(X,Se,I),I.programs=Yt.programs,w.capabilities=fe,w.extensions=Se,w.properties=A,w.renderLists=At,w.shadowMap=Ft,w.state=qt,w.info=I}vt(),b!==Si&&(q=new pR(b,n.width,n.height,r,o));const bt=new n2(w,X);this.xr=bt,this.getContext=function(){return X},this.getContextAttributes=function(){return X.getContextAttributes()},this.forceContextLoss=function(){const N=Se.get("WEBGL_lose_context");N&&N.loseContext()},this.forceContextRestore=function(){const N=Se.get("WEBGL_lose_context");N&&N.restoreContext()},this.getPixelRatio=function(){return ct},this.setPixelRatio=function(N){N!==void 0&&(ct=N,this.setSize(F,j,!1))},this.getSize=function(N){return N.set(F,j)},this.setSize=function(N,tt,ft=!0){if(bt.isPresenting){pe("WebGLRenderer: Can't change size while VR device is presenting.");return}F=N,j=tt,n.width=Math.floor(N*ct),n.height=Math.floor(tt*ct),ft===!0&&(n.style.width=N+"px",n.style.height=tt+"px"),q!==null&&q.setSize(n.width,n.height),this.setViewport(0,0,N,tt)},this.getDrawingBufferSize=function(N){return N.set(F*ct,j*ct).floor()},this.setDrawingBufferSize=function(N,tt,ft){F=N,j=tt,ct=ft,n.width=Math.floor(N*ft),n.height=Math.floor(tt*ft),this.setViewport(0,0,N,tt)},this.setEffects=function(N){if(b===Si){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(N){for(let tt=0;tt<N.length;tt++)if(N[tt].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}q.setEffects(N||[])},this.getCurrentViewport=function(N){return N.copy(z)},this.getViewport=function(N){return N.copy(nt)},this.setViewport=function(N,tt,ft,rt){N.isVector4?nt.set(N.x,N.y,N.z,N.w):nt.set(N,tt,ft,rt),qt.viewport(z.copy(nt).multiplyScalar(ct).round())},this.getScissor=function(N){return N.copy(gt)},this.setScissor=function(N,tt,ft,rt){N.isVector4?gt.set(N.x,N.y,N.z,N.w):gt.set(N,tt,ft,rt),qt.scissor(G.copy(gt).multiplyScalar(ct).round())},this.getScissorTest=function(){return Ct},this.setScissorTest=function(N){qt.setScissorTest(Ct=N)},this.setOpaqueSort=function(N){Tt=N},this.setTransparentSort=function(N){Dt=N},this.getClearColor=function(N){return N.copy(Lt.getClearColor())},this.setClearColor=function(){Lt.setClearColor(...arguments)},this.getClearAlpha=function(){return Lt.getClearAlpha()},this.setClearAlpha=function(){Lt.setClearAlpha(...arguments)},this.clear=function(N=!0,tt=!0,ft=!0){let rt=0;if(N){let it=!1;if(V!==null){const Bt=V.texture.format;it=S.has(Bt)}if(it){const Bt=V.texture.type,kt=x.has(Bt),It=Lt.getClearColor(),jt=Lt.getClearAlpha(),Jt=It.r,ae=It.g,$t=It.b;kt?(T[0]=Jt,T[1]=ae,T[2]=$t,T[3]=jt,X.clearBufferuiv(X.COLOR,0,T)):(U[0]=Jt,U[1]=ae,U[2]=$t,U[3]=jt,X.clearBufferiv(X.COLOR,0,U))}else rt|=X.COLOR_BUFFER_BIT}tt&&(rt|=X.DEPTH_BUFFER_BIT),ft&&(rt|=X.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),X.clear(rt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",Qt,!1),n.removeEventListener("webglcontextrestored",Xt,!1),n.removeEventListener("webglcontextcreationerror",le,!1),Lt.dispose(),At.dispose(),wt.dispose(),A.dispose(),_t.dispose(),Et.dispose(),Ut.dispose(),pt.dispose(),ut.dispose(),Yt.dispose(),bt.dispose(),bt.removeEventListener("sessionstart",Hn),bt.removeEventListener("sessionend",ns),ci.stop()};function Qt(N){N.preventDefault(),d_("WebGLRenderer: Context Lost."),O=!0}function Xt(){d_("WebGLRenderer: Context Restored."),O=!1;const N=I.autoReset,tt=Ft.enabled,ft=Ft.autoUpdate,rt=Ft.needsUpdate,it=Ft.type;vt(),I.autoReset=N,Ft.enabled=tt,Ft.autoUpdate=ft,Ft.needsUpdate=rt,Ft.type=it}function le(N){Ne("WebGLRenderer: A WebGL context could not be created. Reason: ",N.statusMessage)}function Je(N){const tt=N.target;tt.removeEventListener("dispose",Je),Ve(tt)}function Ve(N){oi(N),A.remove(N)}function oi(N){const tt=A.get(N).programs;tt!==void 0&&(tt.forEach(function(ft){Yt.releaseProgram(ft)}),N.isShaderMaterial&&Yt.releaseShaderCache(N))}this.renderBufferDirect=function(N,tt,ft,rt,it,Bt){tt===null&&(tt=be);const kt=it.isMesh&&it.matrixWorld.determinant()<0,It=Ki(N,tt,ft,rt,it);qt.setMaterial(rt,kt);let jt=ft.index,Jt=1;if(rt.wireframe===!0){if(jt=Wt.getWireframeAttribute(ft),jt===void 0)return;Jt=2}const ae=ft.drawRange,$t=ft.attributes.position;let re=ae.start*Jt,Fe=(ae.start+ae.count)*Jt;Bt!==null&&(re=Math.max(re,Bt.start*Jt),Fe=Math.min(Fe,(Bt.start+Bt.count)*Jt)),jt!==null?(re=Math.max(re,0),Fe=Math.min(Fe,jt.count)):$t!=null&&(re=Math.max(re,0),Fe=Math.min(Fe,$t.count));const rn=Fe-re;if(rn<0||rn===1/0)return;pt.setup(it,rt,It,ft,jt);let tn,ke=Z;if(jt!==null&&(tn=ht.get(jt),ke=Ot,ke.setIndex(tn)),it.isMesh)rt.wireframe===!0?(qt.setLineWidth(rt.wireframeLinewidth*en()),ke.setMode(X.LINES)):ke.setMode(X.TRIANGLES);else if(it.isLine){let ee=rt.linewidth;ee===void 0&&(ee=1),qt.setLineWidth(ee*en()),it.isLineSegments?ke.setMode(X.LINES):it.isLineLoop?ke.setMode(X.LINE_LOOP):ke.setMode(X.LINE_STRIP)}else it.isPoints?ke.setMode(X.POINTS):it.isSprite&&ke.setMode(X.TRIANGLES);if(it.isBatchedMesh)if(it._multiDrawInstances!==null)zl("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ke.renderMultiDrawInstances(it._multiDrawStarts,it._multiDrawCounts,it._multiDrawCount,it._multiDrawInstances);else if(Se.get("WEBGL_multi_draw"))ke.renderMultiDraw(it._multiDrawStarts,it._multiDrawCounts,it._multiDrawCount);else{const ee=it._multiDrawStarts,Ie=it._multiDrawCounts,he=it._multiDrawCount,Cn=jt?ht.get(jt).bytesPerElement:1,xa=A.get(rt).currentProgram.getUniforms();for(let Dn=0;Dn<he;Dn++)xa.setValue(X,"_gl_DrawID",Dn),ke.render(ee[Dn]/Cn,Ie[Dn])}else if(it.isInstancedMesh)ke.renderInstances(re,rn,it.count);else if(ft.isInstancedBufferGeometry){const ee=ft._maxInstanceCount!==void 0?ft._maxInstanceCount:1/0,Ie=Math.min(ft.instanceCount,ee);ke.renderInstances(re,rn,Ie)}else ke.render(re,rn)};function Le(N,tt,ft){N.transparent===!0&&N.side===ja&&N.forceSinglePass===!1?(N.side=ri,N.needsUpdate=!0,Zi(N,tt,ft),N.side=Fs,N.needsUpdate=!0,Zi(N,tt,ft),N.side=ja):Zi(N,tt,ft)}this.compile=function(N,tt,ft=null){ft===null&&(ft=N),L=wt.get(ft),L.init(tt),P.push(L),ft.traverseVisible(function(it){it.isLight&&it.layers.test(tt.layers)&&(L.pushLight(it),it.castShadow&&L.pushShadow(it))}),N!==ft&&N.traverseVisible(function(it){it.isLight&&it.layers.test(tt.layers)&&(L.pushLight(it),it.castShadow&&L.pushShadow(it))}),L.setupLights();const rt=new Set;return N.traverse(function(it){if(!(it.isMesh||it.isPoints||it.isLine||it.isSprite))return;const Bt=it.material;if(Bt)if(Array.isArray(Bt))for(let kt=0;kt<Bt.length;kt++){const It=Bt[kt];Le(It,ft,it),rt.add(It)}else Le(Bt,ft,it),rt.add(Bt)}),L=P.pop(),rt},this.compileAsync=function(N,tt,ft=null){const rt=this.compile(N,tt,ft);return new Promise(it=>{function Bt(){if(rt.forEach(function(kt){A.get(kt).currentProgram.isReady()&&rt.delete(kt)}),rt.size===0){it(N);return}setTimeout(Bt,10)}Se.get("KHR_parallel_shader_compile")!==null?Bt():setTimeout(Bt,10)})};let Zn=null;function li(N){Zn&&Zn(N)}function Hn(){ci.stop()}function ns(){ci.start()}const ci=new $x;ci.setAnimationLoop(li),typeof self<"u"&&ci.setContext(self),this.setAnimationLoop=function(N){Zn=N,bt.setAnimationLoop(N),N===null?ci.stop():ci.start()},bt.addEventListener("sessionstart",Hn),bt.addEventListener("sessionend",ns),this.render=function(N,tt){if(tt!==void 0&&tt.isCamera!==!0){Ne("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(O===!0)return;const ft=bt.enabled===!0&&bt.isPresenting===!0,rt=q!==null&&(V===null||ft)&&q.begin(w,V);if(N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),tt.parent===null&&tt.matrixWorldAutoUpdate===!0&&tt.updateMatrixWorld(),bt.enabled===!0&&bt.isPresenting===!0&&(q===null||q.isCompositing()===!1)&&(bt.cameraAutoUpdate===!0&&bt.updateCamera(tt),tt=bt.getCamera()),N.isScene===!0&&N.onBeforeRender(w,N,tt,V),L=wt.get(N,P.length),L.init(tt),P.push(L),De.multiplyMatrices(tt.projectionMatrix,tt.matrixWorldInverse),Pt.setFromProjectionMatrix(De,ua,tt.reversedDepth),ye=this.localClippingEnabled,Nt=Gt.init(this.clippingPlanes,ye),C=At.get(N,B.length),C.init(),B.push(C),bt.enabled===!0&&bt.isPresenting===!0){const kt=w.xr.getDepthSensingMesh();kt!==null&&Kn(kt,tt,-1/0,w.sortObjects)}Kn(N,tt,0,w.sortObjects),C.finish(),w.sortObjects===!0&&C.sort(Tt,Dt),ce=bt.enabled===!1||bt.isPresenting===!1||bt.hasDepthSensing()===!1,ce&&Lt.addToRenderList(C,N),this.info.render.frame++,Nt===!0&&Gt.beginShadows();const it=L.state.shadowsArray;if(Ft.render(it,N,tt),Nt===!0&&Gt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(rt&&q.hasRenderPass())===!1){const kt=C.opaque,It=C.transmissive;if(L.setupLights(),tt.isArrayCamera){const jt=tt.cameras;if(It.length>0)for(let Jt=0,ae=jt.length;Jt<ae;Jt++){const $t=jt[Jt];Sn(kt,It,N,$t)}ce&&Lt.render(N);for(let Jt=0,ae=jt.length;Jt<ae;Jt++){const $t=jt[Jt];ln(C,N,$t,$t.viewport)}}else It.length>0&&Sn(kt,It,N,tt),ce&&Lt.render(N),ln(C,N,tt)}V!==null&&$===0&&(J.updateMultisampleRenderTarget(V),J.updateRenderTargetMipmap(V)),rt&&q.end(w),N.isScene===!0&&N.onAfterRender(w,N,tt),pt.resetDefaultState(),K=-1,W=null,P.pop(),P.length>0?(L=P[P.length-1],Nt===!0&&Gt.setGlobalState(w.clippingPlanes,L.state.camera)):L=null,B.pop(),B.length>0?C=B[B.length-1]:C=null};function Kn(N,tt,ft,rt){if(N.visible===!1)return;if(N.layers.test(tt.layers)){if(N.isGroup)ft=N.renderOrder;else if(N.isLOD)N.autoUpdate===!0&&N.update(tt);else if(N.isLight)L.pushLight(N),N.castShadow&&L.pushShadow(N);else if(N.isSprite){if(!N.frustumCulled||Pt.intersectsSprite(N)){rt&&ie.setFromMatrixPosition(N.matrixWorld).applyMatrix4(De);const kt=Ut.update(N),It=N.material;It.visible&&C.push(N,kt,It,ft,ie.z,null)}}else if((N.isMesh||N.isLine||N.isPoints)&&(!N.frustumCulled||Pt.intersectsObject(N))){const kt=Ut.update(N),It=N.material;if(rt&&(N.boundingSphere!==void 0?(N.boundingSphere===null&&N.computeBoundingSphere(),ie.copy(N.boundingSphere.center)):(kt.boundingSphere===null&&kt.computeBoundingSphere(),ie.copy(kt.boundingSphere.center)),ie.applyMatrix4(N.matrixWorld).applyMatrix4(De)),Array.isArray(It)){const jt=kt.groups;for(let Jt=0,ae=jt.length;Jt<ae;Jt++){const $t=jt[Jt],re=It[$t.materialIndex];re&&re.visible&&C.push(N,kt,re,ft,ie.z,$t)}}else It.visible&&C.push(N,kt,It,ft,ie.z,null)}}const Bt=N.children;for(let kt=0,It=Bt.length;kt<It;kt++)Kn(Bt[kt],tt,ft,rt)}function ln(N,tt,ft,rt){const{opaque:it,transmissive:Bt,transparent:kt}=N;L.setupLightsView(ft),Nt===!0&&Gt.setGlobalState(w.clippingPlanes,ft),rt&&qt.viewport(z.copy(rt)),it.length>0&&ui(it,tt,ft),Bt.length>0&&ui(Bt,tt,ft),kt.length>0&&ui(kt,tt,ft),qt.buffers.depth.setTest(!0),qt.buffers.depth.setMask(!0),qt.buffers.color.setMask(!0),qt.setPolygonOffset(!1)}function Sn(N,tt,ft,rt){if((ft.isScene===!0?ft.overrideMaterial:null)!==null)return;if(L.state.transmissionRenderTarget[rt.id]===void 0){const re=Se.has("EXT_color_buffer_half_float")||Se.has("EXT_color_buffer_float");L.state.transmissionRenderTarget[rt.id]=new ha(1,1,{generateMipmaps:!0,type:re?$a:Si,minFilter:Ps,samples:fe.samples,stencilBuffer:o,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ue.workingColorSpace})}const Bt=L.state.transmissionRenderTarget[rt.id],kt=rt.viewport||z;Bt.setSize(kt.z*w.transmissionResolutionScale,kt.w*w.transmissionResolutionScale);const It=w.getRenderTarget(),jt=w.getActiveCubeFace(),Jt=w.getActiveMipmapLevel();w.setRenderTarget(Bt),w.getClearColor(mt),yt=w.getClearAlpha(),yt<1&&w.setClearColor(16777215,.5),w.clear(),ce&&Lt.render(ft);const ae=w.toneMapping;w.toneMapping=Yi;const $t=rt.viewport;if(rt.viewport!==void 0&&(rt.viewport=void 0),L.setupLightsView(rt),Nt===!0&&Gt.setGlobalState(w.clippingPlanes,rt),ui(N,ft,rt),J.updateMultisampleRenderTarget(Bt),J.updateRenderTargetMipmap(Bt),Se.has("WEBGL_multisampled_render_to_texture")===!1){let re=!1;for(let Fe=0,rn=tt.length;Fe<rn;Fe++){const tn=tt[Fe],{object:ke,geometry:ee,material:Ie,group:he}=tn;if(Ie.side===ja&&ke.layers.test(rt.layers)){const Cn=Ie.side;Ie.side=ri,Ie.needsUpdate=!0,fi(ke,ft,rt,ee,Ie,he),Ie.side=Cn,Ie.needsUpdate=!0,re=!0}}re===!0&&(J.updateMultisampleRenderTarget(Bt),J.updateRenderTargetMipmap(Bt))}w.setRenderTarget(It,jt,Jt),w.setClearColor(mt,yt),$t!==void 0&&(rt.viewport=$t),w.toneMapping=ae}function ui(N,tt,ft){const rt=tt.isScene===!0?tt.overrideMaterial:null;for(let it=0,Bt=N.length;it<Bt;it++){const kt=N[it],{object:It,geometry:jt,group:Jt}=kt;let ae=kt.material;ae.allowOverride===!0&&rt!==null&&(ae=rt),It.layers.test(ft.layers)&&fi(It,tt,ft,jt,ae,Jt)}}function fi(N,tt,ft,rt,it,Bt){N.onBeforeRender(w,tt,ft,rt,it,Bt),N.modelViewMatrix.multiplyMatrices(ft.matrixWorldInverse,N.matrixWorld),N.normalMatrix.getNormalMatrix(N.modelViewMatrix),it.onBeforeRender(w,tt,ft,rt,N,Bt),it.transparent===!0&&it.side===ja&&it.forceSinglePass===!1?(it.side=ri,it.needsUpdate=!0,w.renderBufferDirect(ft,tt,rt,it,N,Bt),it.side=Fs,it.needsUpdate=!0,w.renderBufferDirect(ft,tt,rt,it,N,Bt),it.side=ja):w.renderBufferDirect(ft,tt,rt,it,N,Bt),N.onAfterRender(w,tt,ft,rt,it,Bt)}function Zi(N,tt,ft){tt.isScene!==!0&&(tt=be);const rt=A.get(N),it=L.state.lights,Bt=L.state.shadowsArray,kt=it.state.version,It=Yt.getParameters(N,it.state,Bt,tt,ft),jt=Yt.getProgramCacheKey(It);let Jt=rt.programs;rt.environment=N.isMeshStandardMaterial?tt.environment:null,rt.fog=tt.fog,rt.envMap=(N.isMeshStandardMaterial?Et:_t).get(N.envMap||rt.environment),rt.envMapRotation=rt.environment!==null&&N.envMap===null?tt.environmentRotation:N.envMapRotation,Jt===void 0&&(N.addEventListener("dispose",Je),Jt=new Map,rt.programs=Jt);let ae=Jt.get(jt);if(ae!==void 0){if(rt.currentProgram===ae&&rt.lightsStateVersion===kt)return is(N,It),ae}else It.uniforms=Yt.getUniforms(N),N.onBeforeCompile(It,w),ae=Yt.acquireProgram(It,jt),Jt.set(jt,ae),rt.uniforms=It.uniforms;const $t=rt.uniforms;return(!N.isShaderMaterial&&!N.isRawShaderMaterial||N.clipping===!0)&&($t.clippingPlanes=Gt.uniform),is(N,It),rt.needsLights=Qi(N),rt.lightsStateVersion=kt,rt.needsLights&&($t.ambientLightColor.value=it.state.ambient,$t.lightProbe.value=it.state.probe,$t.directionalLights.value=it.state.directional,$t.directionalLightShadows.value=it.state.directionalShadow,$t.spotLights.value=it.state.spot,$t.spotLightShadows.value=it.state.spotShadow,$t.rectAreaLights.value=it.state.rectArea,$t.ltc_1.value=it.state.rectAreaLTC1,$t.ltc_2.value=it.state.rectAreaLTC2,$t.pointLights.value=it.state.point,$t.pointLightShadows.value=it.state.pointShadow,$t.hemisphereLights.value=it.state.hemi,$t.directionalShadowMap.value=it.state.directionalShadowMap,$t.directionalShadowMatrix.value=it.state.directionalShadowMatrix,$t.spotShadowMap.value=it.state.spotShadowMap,$t.spotLightMatrix.value=it.state.spotLightMatrix,$t.spotLightMap.value=it.state.spotLightMap,$t.pointShadowMap.value=it.state.pointShadowMap,$t.pointShadowMatrix.value=it.state.pointShadowMatrix),rt.currentProgram=ae,rt.uniformsList=null,ae}function va(N){if(N.uniformsList===null){const tt=N.currentProgram.getUniforms();N.uniformsList=Ru.seqWithValue(tt.seq,N.uniforms)}return N.uniformsList}function is(N,tt){const ft=A.get(N);ft.outputColorSpace=tt.outputColorSpace,ft.batching=tt.batching,ft.batchingColor=tt.batchingColor,ft.instancing=tt.instancing,ft.instancingColor=tt.instancingColor,ft.instancingMorph=tt.instancingMorph,ft.skinning=tt.skinning,ft.morphTargets=tt.morphTargets,ft.morphNormals=tt.morphNormals,ft.morphColors=tt.morphColors,ft.morphTargetsCount=tt.morphTargetsCount,ft.numClippingPlanes=tt.numClippingPlanes,ft.numIntersection=tt.numClipIntersection,ft.vertexAlphas=tt.vertexAlphas,ft.vertexTangents=tt.vertexTangents,ft.toneMapping=tt.toneMapping}function Ki(N,tt,ft,rt,it){tt.isScene!==!0&&(tt=be),J.resetTextureUnits();const Bt=tt.fog,kt=rt.isMeshStandardMaterial?tt.environment:null,It=V===null?w.outputColorSpace:V.isXRRenderTarget===!0?V.texture.colorSpace:bo,jt=(rt.isMeshStandardMaterial?Et:_t).get(rt.envMap||kt),Jt=rt.vertexColors===!0&&!!ft.attributes.color&&ft.attributes.color.itemSize===4,ae=!!ft.attributes.tangent&&(!!rt.normalMap||rt.anisotropy>0),$t=!!ft.morphAttributes.position,re=!!ft.morphAttributes.normal,Fe=!!ft.morphAttributes.color;let rn=Yi;rt.toneMapped&&(V===null||V.isXRRenderTarget===!0)&&(rn=w.toneMapping);const tn=ft.morphAttributes.position||ft.morphAttributes.normal||ft.morphAttributes.color,ke=tn!==void 0?tn.length:0,ee=A.get(rt),Ie=L.state.lights;if(Nt===!0&&(ye===!0||N!==W)){const Un=N===W&&rt.id===K;Gt.setState(rt,N,Un)}let he=!1;rt.version===ee.__version?(ee.needsLights&&ee.lightsStateVersion!==Ie.state.version||ee.outputColorSpace!==It||it.isBatchedMesh&&ee.batching===!1||!it.isBatchedMesh&&ee.batching===!0||it.isBatchedMesh&&ee.batchingColor===!0&&it.colorTexture===null||it.isBatchedMesh&&ee.batchingColor===!1&&it.colorTexture!==null||it.isInstancedMesh&&ee.instancing===!1||!it.isInstancedMesh&&ee.instancing===!0||it.isSkinnedMesh&&ee.skinning===!1||!it.isSkinnedMesh&&ee.skinning===!0||it.isInstancedMesh&&ee.instancingColor===!0&&it.instanceColor===null||it.isInstancedMesh&&ee.instancingColor===!1&&it.instanceColor!==null||it.isInstancedMesh&&ee.instancingMorph===!0&&it.morphTexture===null||it.isInstancedMesh&&ee.instancingMorph===!1&&it.morphTexture!==null||ee.envMap!==jt||rt.fog===!0&&ee.fog!==Bt||ee.numClippingPlanes!==void 0&&(ee.numClippingPlanes!==Gt.numPlanes||ee.numIntersection!==Gt.numIntersection)||ee.vertexAlphas!==Jt||ee.vertexTangents!==ae||ee.morphTargets!==$t||ee.morphNormals!==re||ee.morphColors!==Fe||ee.toneMapping!==rn||ee.morphTargetsCount!==ke)&&(he=!0):(he=!0,ee.__version=rt.version);let Cn=ee.currentProgram;he===!0&&(Cn=Zi(rt,tt,it));let xa=!1,Dn=!1,Ei=!1;const qe=Cn.getUniforms(),Nn=ee.uniforms;if(qt.useProgram(Cn.program)&&(xa=!0,Dn=!0,Ei=!0),rt.id!==K&&(K=rt.id,Dn=!0),xa||W!==N){qt.buffers.depth.getReversed()&&N.reversedDepth!==!0&&(N._reversedDepth=!0,N.updateProjectionMatrix()),qe.setValue(X,"projectionMatrix",N.projectionMatrix),qe.setValue(X,"viewMatrix",N.matrixWorldInverse);const Ln=qe.map.cameraPosition;Ln!==void 0&&Ln.setValue(X,ue.setFromMatrixPosition(N.matrixWorld)),fe.logarithmicDepthBuffer&&qe.setValue(X,"logDepthBufFC",2/(Math.log(N.far+1)/Math.LN2)),(rt.isMeshPhongMaterial||rt.isMeshToonMaterial||rt.isMeshLambertMaterial||rt.isMeshBasicMaterial||rt.isMeshStandardMaterial||rt.isShaderMaterial)&&qe.setValue(X,"isOrthographic",N.isOrthographicCamera===!0),W!==N&&(W=N,Dn=!0,Ei=!0)}if(ee.needsLights&&(Ie.state.directionalShadowMap.length>0&&qe.setValue(X,"directionalShadowMap",Ie.state.directionalShadowMap,J),Ie.state.spotShadowMap.length>0&&qe.setValue(X,"spotShadowMap",Ie.state.spotShadowMap,J),Ie.state.pointShadowMap.length>0&&qe.setValue(X,"pointShadowMap",Ie.state.pointShadowMap,J)),it.isSkinnedMesh){qe.setOptional(X,it,"bindMatrix"),qe.setOptional(X,it,"bindMatrixInverse");const Un=it.skeleton;Un&&(Un.boneTexture===null&&Un.computeBoneTexture(),qe.setValue(X,"boneTexture",Un.boneTexture,J))}it.isBatchedMesh&&(qe.setOptional(X,it,"batchingTexture"),qe.setValue(X,"batchingTexture",it._matricesTexture,J),qe.setOptional(X,it,"batchingIdTexture"),qe.setValue(X,"batchingIdTexture",it._indirectTexture,J),qe.setOptional(X,it,"batchingColorTexture"),it._colorsTexture!==null&&qe.setValue(X,"batchingColorTexture",it._colorsTexture,J));const Mn=ft.morphAttributes;if((Mn.position!==void 0||Mn.normal!==void 0||Mn.color!==void 0)&&me.update(it,ft,Cn),(Dn||ee.receiveShadow!==it.receiveShadow)&&(ee.receiveShadow=it.receiveShadow,qe.setValue(X,"receiveShadow",it.receiveShadow)),rt.isMeshGouraudMaterial&&rt.envMap!==null&&(Nn.envMap.value=jt,Nn.flipEnvMap.value=jt.isCubeTexture&&jt.isRenderTargetTexture===!1?-1:1),rt.isMeshStandardMaterial&&rt.envMap===null&&tt.environment!==null&&(Nn.envMapIntensity.value=tt.environmentIntensity),Nn.dfgLUT!==void 0&&(Nn.dfgLUT.value=o2()),Dn&&(qe.setValue(X,"toneMappingExposure",w.toneMappingExposure),ee.needsLights&&Is(Nn,Ei),Bt&&rt.fog===!0&&se.refreshFogUniforms(Nn,Bt),se.refreshMaterialUniforms(Nn,rt,ct,j,L.state.transmissionRenderTarget[N.id]),Ru.upload(X,va(ee),Nn,J)),rt.isShaderMaterial&&rt.uniformsNeedUpdate===!0&&(Ru.upload(X,va(ee),Nn,J),rt.uniformsNeedUpdate=!1),rt.isSpriteMaterial&&qe.setValue(X,"center",it.center),qe.setValue(X,"modelViewMatrix",it.modelViewMatrix),qe.setValue(X,"normalMatrix",it.normalMatrix),qe.setValue(X,"modelMatrix",it.matrixWorld),rt.isShaderMaterial||rt.isRawShaderMaterial){const Un=rt.uniformsGroups;for(let Ln=0,yr=Un.length;Ln<yr;Ln++){const zi=Un[Ln];ut.update(zi,Cn),ut.bind(zi,Cn)}}return Cn}function Is(N,tt){N.ambientLightColor.needsUpdate=tt,N.lightProbe.needsUpdate=tt,N.directionalLights.needsUpdate=tt,N.directionalLightShadows.needsUpdate=tt,N.pointLights.needsUpdate=tt,N.pointLightShadows.needsUpdate=tt,N.spotLights.needsUpdate=tt,N.spotLightShadows.needsUpdate=tt,N.rectAreaLights.needsUpdate=tt,N.hemisphereLights.needsUpdate=tt}function Qi(N){return N.isMeshLambertMaterial||N.isMeshToonMaterial||N.isMeshPhongMaterial||N.isMeshStandardMaterial||N.isShadowMaterial||N.isShaderMaterial&&N.lights===!0}this.getActiveCubeFace=function(){return H},this.getActiveMipmapLevel=function(){return $},this.getRenderTarget=function(){return V},this.setRenderTargetTextures=function(N,tt,ft){const rt=A.get(N);rt.__autoAllocateDepthBuffer=N.resolveDepthBuffer===!1,rt.__autoAllocateDepthBuffer===!1&&(rt.__useRenderToTexture=!1),A.get(N.texture).__webglTexture=tt,A.get(N.depthTexture).__webglTexture=rt.__autoAllocateDepthBuffer?void 0:ft,rt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(N,tt){const ft=A.get(N);ft.__webglFramebuffer=tt,ft.__useDefaultFramebuffer=tt===void 0};const Oi=X.createFramebuffer();this.setRenderTarget=function(N,tt=0,ft=0){V=N,H=tt,$=ft;let rt=null,it=!1,Bt=!1;if(N){const It=A.get(N);if(It.__useDefaultFramebuffer!==void 0){qt.bindFramebuffer(X.FRAMEBUFFER,It.__webglFramebuffer),z.copy(N.viewport),G.copy(N.scissor),Q=N.scissorTest,qt.viewport(z),qt.scissor(G),qt.setScissorTest(Q),K=-1;return}else if(It.__webglFramebuffer===void 0)J.setupRenderTarget(N);else if(It.__hasExternalTextures)J.rebindTextures(N,A.get(N.texture).__webglTexture,A.get(N.depthTexture).__webglTexture);else if(N.depthBuffer){const ae=N.depthTexture;if(It.__boundDepthTexture!==ae){if(ae!==null&&A.has(ae)&&(N.width!==ae.image.width||N.height!==ae.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");J.setupDepthRenderbuffer(N)}}const jt=N.texture;(jt.isData3DTexture||jt.isDataArrayTexture||jt.isCompressedArrayTexture)&&(Bt=!0);const Jt=A.get(N).__webglFramebuffer;N.isWebGLCubeRenderTarget?(Array.isArray(Jt[tt])?rt=Jt[tt][ft]:rt=Jt[tt],it=!0):N.samples>0&&J.useMultisampledRTT(N)===!1?rt=A.get(N).__webglMultisampledFramebuffer:Array.isArray(Jt)?rt=Jt[ft]:rt=Jt,z.copy(N.viewport),G.copy(N.scissor),Q=N.scissorTest}else z.copy(nt).multiplyScalar(ct).floor(),G.copy(gt).multiplyScalar(ct).floor(),Q=Ct;if(ft!==0&&(rt=Oi),qt.bindFramebuffer(X.FRAMEBUFFER,rt)&&qt.drawBuffers(N,rt),qt.viewport(z),qt.scissor(G),qt.setScissorTest(Q),it){const It=A.get(N.texture);X.framebufferTexture2D(X.FRAMEBUFFER,X.COLOR_ATTACHMENT0,X.TEXTURE_CUBE_MAP_POSITIVE_X+tt,It.__webglTexture,ft)}else if(Bt){const It=tt;for(let jt=0;jt<N.textures.length;jt++){const Jt=A.get(N.textures[jt]);X.framebufferTextureLayer(X.FRAMEBUFFER,X.COLOR_ATTACHMENT0+jt,Jt.__webglTexture,ft,It)}}else if(N!==null&&ft!==0){const It=A.get(N.texture);X.framebufferTexture2D(X.FRAMEBUFFER,X.COLOR_ATTACHMENT0,X.TEXTURE_2D,It.__webglTexture,ft)}K=-1},this.readRenderTargetPixels=function(N,tt,ft,rt,it,Bt,kt,It=0){if(!(N&&N.isWebGLRenderTarget)){Ne("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let jt=A.get(N).__webglFramebuffer;if(N.isWebGLCubeRenderTarget&&kt!==void 0&&(jt=jt[kt]),jt){qt.bindFramebuffer(X.FRAMEBUFFER,jt);try{const Jt=N.textures[It],ae=Jt.format,$t=Jt.type;if(!fe.textureFormatReadable(ae)){Ne("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!fe.textureTypeReadable($t)){Ne("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}tt>=0&&tt<=N.width-rt&&ft>=0&&ft<=N.height-it&&(N.textures.length>1&&X.readBuffer(X.COLOR_ATTACHMENT0+It),X.readPixels(tt,ft,rt,it,Rt.convert(ae),Rt.convert($t),Bt))}finally{const Jt=V!==null?A.get(V).__webglFramebuffer:null;qt.bindFramebuffer(X.FRAMEBUFFER,Jt)}}},this.readRenderTargetPixelsAsync=async function(N,tt,ft,rt,it,Bt,kt,It=0){if(!(N&&N.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let jt=A.get(N).__webglFramebuffer;if(N.isWebGLCubeRenderTarget&&kt!==void 0&&(jt=jt[kt]),jt)if(tt>=0&&tt<=N.width-rt&&ft>=0&&ft<=N.height-it){qt.bindFramebuffer(X.FRAMEBUFFER,jt);const Jt=N.textures[It],ae=Jt.format,$t=Jt.type;if(!fe.textureFormatReadable(ae))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!fe.textureTypeReadable($t))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const re=X.createBuffer();X.bindBuffer(X.PIXEL_PACK_BUFFER,re),X.bufferData(X.PIXEL_PACK_BUFFER,Bt.byteLength,X.STREAM_READ),N.textures.length>1&&X.readBuffer(X.COLOR_ATTACHMENT0+It),X.readPixels(tt,ft,rt,it,Rt.convert(ae),Rt.convert($t),0);const Fe=V!==null?A.get(V).__webglFramebuffer:null;qt.bindFramebuffer(X.FRAMEBUFFER,Fe);const rn=X.fenceSync(X.SYNC_GPU_COMMANDS_COMPLETE,0);return X.flush(),await A1(X,rn,4),X.bindBuffer(X.PIXEL_PACK_BUFFER,re),X.getBufferSubData(X.PIXEL_PACK_BUFFER,0,Bt),X.deleteBuffer(re),X.deleteSync(rn),Bt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(N,tt=null,ft=0){const rt=Math.pow(2,-ft),it=Math.floor(N.image.width*rt),Bt=Math.floor(N.image.height*rt),kt=tt!==null?tt.x:0,It=tt!==null?tt.y:0;J.setTexture2D(N,0),X.copyTexSubImage2D(X.TEXTURE_2D,ft,0,0,kt,It,it,Bt),qt.unbindTexture()};const _a=X.createFramebuffer(),Ji=X.createFramebuffer();this.copyTextureToTexture=function(N,tt,ft=null,rt=null,it=0,Bt=null){Bt===null&&(it!==0?(zl("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Bt=it,it=0):Bt=0);let kt,It,jt,Jt,ae,$t,re,Fe,rn;const tn=N.isCompressedTexture?N.mipmaps[Bt]:N.image;if(ft!==null)kt=ft.max.x-ft.min.x,It=ft.max.y-ft.min.y,jt=ft.isBox3?ft.max.z-ft.min.z:1,Jt=ft.min.x,ae=ft.min.y,$t=ft.isBox3?ft.min.z:0;else{const Mn=Math.pow(2,-it);kt=Math.floor(tn.width*Mn),It=Math.floor(tn.height*Mn),N.isDataArrayTexture?jt=tn.depth:N.isData3DTexture?jt=Math.floor(tn.depth*Mn):jt=1,Jt=0,ae=0,$t=0}rt!==null?(re=rt.x,Fe=rt.y,rn=rt.z):(re=0,Fe=0,rn=0);const ke=Rt.convert(tt.format),ee=Rt.convert(tt.type);let Ie;tt.isData3DTexture?(J.setTexture3D(tt,0),Ie=X.TEXTURE_3D):tt.isDataArrayTexture||tt.isCompressedArrayTexture?(J.setTexture2DArray(tt,0),Ie=X.TEXTURE_2D_ARRAY):(J.setTexture2D(tt,0),Ie=X.TEXTURE_2D),X.pixelStorei(X.UNPACK_FLIP_Y_WEBGL,tt.flipY),X.pixelStorei(X.UNPACK_PREMULTIPLY_ALPHA_WEBGL,tt.premultiplyAlpha),X.pixelStorei(X.UNPACK_ALIGNMENT,tt.unpackAlignment);const he=X.getParameter(X.UNPACK_ROW_LENGTH),Cn=X.getParameter(X.UNPACK_IMAGE_HEIGHT),xa=X.getParameter(X.UNPACK_SKIP_PIXELS),Dn=X.getParameter(X.UNPACK_SKIP_ROWS),Ei=X.getParameter(X.UNPACK_SKIP_IMAGES);X.pixelStorei(X.UNPACK_ROW_LENGTH,tn.width),X.pixelStorei(X.UNPACK_IMAGE_HEIGHT,tn.height),X.pixelStorei(X.UNPACK_SKIP_PIXELS,Jt),X.pixelStorei(X.UNPACK_SKIP_ROWS,ae),X.pixelStorei(X.UNPACK_SKIP_IMAGES,$t);const qe=N.isDataArrayTexture||N.isData3DTexture,Nn=tt.isDataArrayTexture||tt.isData3DTexture;if(N.isDepthTexture){const Mn=A.get(N),Un=A.get(tt),Ln=A.get(Mn.__renderTarget),yr=A.get(Un.__renderTarget);qt.bindFramebuffer(X.READ_FRAMEBUFFER,Ln.__webglFramebuffer),qt.bindFramebuffer(X.DRAW_FRAMEBUFFER,yr.__webglFramebuffer);for(let zi=0;zi<jt;zi++)qe&&(X.framebufferTextureLayer(X.READ_FRAMEBUFFER,X.COLOR_ATTACHMENT0,A.get(N).__webglTexture,it,$t+zi),X.framebufferTextureLayer(X.DRAW_FRAMEBUFFER,X.COLOR_ATTACHMENT0,A.get(tt).__webglTexture,Bt,rn+zi)),X.blitFramebuffer(Jt,ae,kt,It,re,Fe,kt,It,X.DEPTH_BUFFER_BIT,X.NEAREST);qt.bindFramebuffer(X.READ_FRAMEBUFFER,null),qt.bindFramebuffer(X.DRAW_FRAMEBUFFER,null)}else if(it!==0||N.isRenderTargetTexture||A.has(N)){const Mn=A.get(N),Un=A.get(tt);qt.bindFramebuffer(X.READ_FRAMEBUFFER,_a),qt.bindFramebuffer(X.DRAW_FRAMEBUFFER,Ji);for(let Ln=0;Ln<jt;Ln++)qe?X.framebufferTextureLayer(X.READ_FRAMEBUFFER,X.COLOR_ATTACHMENT0,Mn.__webglTexture,it,$t+Ln):X.framebufferTexture2D(X.READ_FRAMEBUFFER,X.COLOR_ATTACHMENT0,X.TEXTURE_2D,Mn.__webglTexture,it),Nn?X.framebufferTextureLayer(X.DRAW_FRAMEBUFFER,X.COLOR_ATTACHMENT0,Un.__webglTexture,Bt,rn+Ln):X.framebufferTexture2D(X.DRAW_FRAMEBUFFER,X.COLOR_ATTACHMENT0,X.TEXTURE_2D,Un.__webglTexture,Bt),it!==0?X.blitFramebuffer(Jt,ae,kt,It,re,Fe,kt,It,X.COLOR_BUFFER_BIT,X.NEAREST):Nn?X.copyTexSubImage3D(Ie,Bt,re,Fe,rn+Ln,Jt,ae,kt,It):X.copyTexSubImage2D(Ie,Bt,re,Fe,Jt,ae,kt,It);qt.bindFramebuffer(X.READ_FRAMEBUFFER,null),qt.bindFramebuffer(X.DRAW_FRAMEBUFFER,null)}else Nn?N.isDataTexture||N.isData3DTexture?X.texSubImage3D(Ie,Bt,re,Fe,rn,kt,It,jt,ke,ee,tn.data):tt.isCompressedArrayTexture?X.compressedTexSubImage3D(Ie,Bt,re,Fe,rn,kt,It,jt,ke,tn.data):X.texSubImage3D(Ie,Bt,re,Fe,rn,kt,It,jt,ke,ee,tn):N.isDataTexture?X.texSubImage2D(X.TEXTURE_2D,Bt,re,Fe,kt,It,ke,ee,tn.data):N.isCompressedTexture?X.compressedTexSubImage2D(X.TEXTURE_2D,Bt,re,Fe,tn.width,tn.height,ke,tn.data):X.texSubImage2D(X.TEXTURE_2D,Bt,re,Fe,kt,It,ke,ee,tn);X.pixelStorei(X.UNPACK_ROW_LENGTH,he),X.pixelStorei(X.UNPACK_IMAGE_HEIGHT,Cn),X.pixelStorei(X.UNPACK_SKIP_PIXELS,xa),X.pixelStorei(X.UNPACK_SKIP_ROWS,Dn),X.pixelStorei(X.UNPACK_SKIP_IMAGES,Ei),Bt===0&&tt.generateMipmaps&&X.generateMipmap(Ie),qt.unbindTexture()},this.initRenderTarget=function(N){A.get(N).__webglFramebuffer===void 0&&J.setupRenderTarget(N)},this.initTexture=function(N){N.isCubeTexture?J.setTextureCube(N,0):N.isData3DTexture?J.setTexture3D(N,0):N.isDataArrayTexture||N.isCompressedArrayTexture?J.setTexture2DArray(N,0):J.setTexture2D(N,0),qt.unbindTexture()},this.resetState=function(){H=0,$=0,V=null,qt.reset(),pt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ua}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const n=this.getContext();n.drawingBufferColorSpace=Ue._getDrawingBufferColorSpace(t),n.unpackColorSpace=Ue._getUnpackColorSpace()}}const Cl=new lt;function Li(c,t,n,a,r,o){const u=2*Math.PI*r/4,f=Math.max(o-2*r,0),p=Math.PI/4;Cl.copy(t),Cl[a]=0,Cl.normalize();const h=.5*u/(u+f),g=1-Cl.angleTo(c)/p;return Math.sign(Cl[n])===1?g*h:f/(u+f)+h+h*(1-g)}class Yp extends wo{constructor(t=1,n=1,a=1,r=2,o=.1){const u=r*2+1;if(o=Math.min(t/2,n/2,a/2,o),super(1,1,1,u,u,u),this.type="RoundedBoxGeometry",this.parameters={width:t,height:n,depth:a,segments:r,radius:o},u===1)return;const f=this.toNonIndexed();this.index=null,this.attributes.position=f.attributes.position,this.attributes.normal=f.attributes.normal,this.attributes.uv=f.attributes.uv;const p=new lt,h=new lt,g=new lt(t,n,a).divideScalar(2).subScalar(o),_=this.attributes.position.array,v=this.attributes.normal.array,y=this.attributes.uv.array,M=_.length/6,b=new lt,S=.5/u;for(let x=0,T=0;x<_.length;x+=3,T+=2)switch(p.fromArray(_,x),h.copy(p),h.x-=Math.sign(h.x)*S,h.y-=Math.sign(h.y)*S,h.z-=Math.sign(h.z)*S,h.normalize(),_[x+0]=g.x*Math.sign(p.x)+h.x*o,_[x+1]=g.y*Math.sign(p.y)+h.y*o,_[x+2]=g.z*Math.sign(p.z)+h.z*o,v[x+0]=h.x,v[x+1]=h.y,v[x+2]=h.z,Math.floor(x/M)){case 0:b.set(1,0,0),y[T+0]=Li(b,h,"z","y",o,a),y[T+1]=1-Li(b,h,"y","z",o,n);break;case 1:b.set(-1,0,0),y[T+0]=1-Li(b,h,"z","y",o,a),y[T+1]=1-Li(b,h,"y","z",o,n);break;case 2:b.set(0,1,0),y[T+0]=1-Li(b,h,"x","z",o,t),y[T+1]=Li(b,h,"z","x",o,a);break;case 3:b.set(0,-1,0),y[T+0]=1-Li(b,h,"x","z",o,t),y[T+1]=1-Li(b,h,"z","x",o,a);break;case 4:b.set(0,0,1),y[T+0]=1-Li(b,h,"x","y",o,t),y[T+1]=1-Li(b,h,"y","x",o,n);break;case 5:b.set(0,0,-1),y[T+0]=Li(b,h,"x","y",o,t),y[T+1]=1-Li(b,h,"y","x",o,n);break}}static fromJSON(t){return new Yp(t.width,t.height,t.depth,t.segments,t.radius)}}const c2=18,Ud=1.2,u2=28;class f2{ctx=null;masterGain=null;lastPlayTime=0;primed=!1;unlock(){const t=this.ensureContext();if(t.state==="suspended"&&t.resume(),!this.primed){this.primed=!0;try{const n=t.createBufferSource();n.buffer=t.createBuffer(1,1,t.sampleRate),n.connect(t.destination),n.start(0)}catch{}}}ensureContext(){return this.ctx||(this.ctx=new AudioContext,this.masterGain=this.ctx.createGain(),this.masterGain.gain.value=.55,this.masterGain.connect(this.ctx.destination)),this.ctx}playImpact(t,n){if(n<Ud)return;const a=performance.now();if(a-this.lastPlayTime<u2)return;this.lastPlayTime=a;const r=this.ensureContext();if(r.state!=="running"&&(this.unlock(),this.ctx?.state!=="running"))return;const o=this.masterGain,u=Math.min((n-Ud)/(c2-Ud),1);t==="table"?this.playTableHit(r,o,u):this.playDiceHit(r,o,u)}playTableHit(t,n,a){const r=t.currentTime,o=.18+a*.42,u=.04+a*.06,f=.02+a*.03,p=this.createNoiseBuffer(t,f),h=t.createBufferSource();h.buffer=p;const g=t.createBiquadFilter();g.type="lowpass",g.frequency.setValueAtTime(800+a*1200,r),g.Q.value=.7;const _=t.createGain();_.gain.setValueAtTime(o*.7,r),_.gain.exponentialRampToValueAtTime(.001,r+u),h.connect(g).connect(_).connect(n),h.start(r),h.stop(r+u+.01);const v=t.createOscillator();v.type="sine",v.frequency.setValueAtTime(90+a*50,r),v.frequency.exponentialRampToValueAtTime(40,r+u);const y=t.createGain();y.gain.setValueAtTime(o*.5,r),y.gain.exponentialRampToValueAtTime(.001,r+u),v.connect(y).connect(n),v.start(r),v.stop(r+u+.01)}playDiceHit(t,n,a){const r=t.currentTime,o=.12+a*.3,u=.018+a*.032,f=.005+a*.008,p=this.createNoiseBuffer(t,f),h=t.createBufferSource();h.buffer=p;const g=t.createBiquadFilter();g.type="highpass",g.frequency.setValueAtTime(1200,r),g.Q.value=.5;const _=t.createBiquadFilter();_.type="lowpass",_.frequency.setValueAtTime(6e3+a*2e3,r),_.Q.value=.6;const v=t.createGain();v.gain.setValueAtTime(o*.9,r),v.gain.exponentialRampToValueAtTime(.001,r+u*.6),h.connect(g).connect(_).connect(v).connect(n),h.start(r),h.stop(r+u+.01);const y=420+a*180,M=y*1.47;for(const b of[y,M]){const S=t.createOscillator();S.type="sine",S.frequency.setValueAtTime(b,r),S.frequency.exponentialRampToValueAtTime(b*.7,r+u);const x=t.createGain();x.gain.setValueAtTime(o*.18,r),x.gain.exponentialRampToValueAtTime(.001,r+u*.8),S.connect(x).connect(n),S.start(r),S.stop(r+u+.01)}}createNoiseBuffer(t,n){const a=Math.ceil(t.sampleRate*n),r=t.createBuffer(1,a,t.sampleRate),o=r.getChannelData(0);for(let u=0;u<a;u++)o[u]=Math.random()*2-1;return r}dispose(){this.ctx&&(this.ctx.close(),this.ctx=null,this.masterGain=null)}}const h2=1.36,d2=2,p2=6.8,m2=6,cr=.9,Os=8,rx=1735242,jp=[3,4,1,6,2,5],g2={1:[[0,0]],2:[[-.52,-.52],[.52,.52]],3:[[-.52,-.52],[0,0],[.52,.52]],4:[[-.52,-.52],[.52,-.52],[-.52,.52],[.52,.52]],5:[[-.52,-.52],[.52,-.52],[0,0],[-.52,.52],[.52,.52]],6:[[-.52,-.52],[.52,-.52],[-.52,0],[.52,0],[-.52,.52],[.52,.52]]},Ld=16777215,ox=15895426,ay=[new R(1,0,0),new R(-1,0,0),new R(0,1,0),new R(0,-1,0),new R(0,0,1),new R(0,0,-1)];function Ya(c){return c==="fast"?{settleHoldSeconds:.03,linearStillThreshold:.14,angularStillThreshold:.18,maxRollSeconds:.7,gravityY:-130,faceUpDrop:!0,spawnYBase:9.5,spawnYStep:.34,solverIterations:6,tableRestitution:.14,diceRestitution:.16,sleepSpeedLimit:.36,sleepTimeLimit:.05,linearDamping:.4,angularDamping:.46,impulseXMin:8.5,impulseXMax:10.6,impulseYMin:3.2,impulseYMax:4.3}:{settleHoldSeconds:.26,linearStillThreshold:.02,angularStillThreshold:.03,maxRollSeconds:null,gravityY:-40,faceUpDrop:!1,spawnYBase:4,spawnYStep:.22,solverIterations:14,tableRestitution:.36,diceRestitution:.4,sleepSpeedLimit:.14,sleepTimeLimit:.18,linearDamping:.17,angularDamping:.19,impulseXMin:12.2,impulseXMax:15.8,impulseYMin:5.4,impulseYMax:7.2}}function v2({diceCount:c=5,maxAttempts:t=3,onDiceResult:n,onRollStart:a,forceSingleAttempt:r=!1,hasPendingPlacement:o=!1,onCommitPlacement:u,rollSpeedMode:f="normal",onRollSpeedModeChange:p}){const h=we.useRef(null),g=we.useRef(()=>{}),_=we.useRef(()=>{}),v=we.useRef(!1),[y,M]=we.useState(!1),[b,S]=we.useState([]),x=we.useRef(b);x.current=b;const[T,U]=we.useState(0),[C,L]=we.useState(()=>Array(c).fill(!1)),B=we.useRef(C);B.current=C;const P=we.useRef(T);P.current=T;const q=we.useRef([]),w=r?1:t,O=we.useRef(w);O.current=w;const H=we.useRef(n);H.current=n;const $=we.useRef(a);$.current=a;const V=we.useRef(f);V.current=f;const K=we.useRef(Ya(f)),W=we.useCallback(ct=>{P.current<1||P.current>=O.current||L(Tt=>{const Dt=[...Tt];Dt[ct]=!Dt[ct];const nt=q.current[ct];if(nt){const gt=nt.mesh.material,Ct=Dt[ct]?ox:Ld;gt.forEach(Pt=>Pt.color.set(Ct))}return Dt})},[]),z=we.useRef(u);z.current=u;const G=we.useCallback(()=>{z.current?.(),U(0),P.current=0,S([]);const ct=Array(c).fill(!1);L(ct),B.current=ct,q.current.forEach(Tt=>{Tt.mesh.material.forEach(nt=>nt.color.set(Ld))}),g.current()},[c]);we.useEffect(()=>{const ct=h.current;if(!ct)return;const Tt=typeof window<"u"&&window.matchMedia("(min-width: 1024px)").matches,Dt=Tt?h2:d2,nt=Dt/2,gt=Tt?p2:m2,Ct=new Q1;Ct.background=new Pe(rx);const Pt=new zu(-1,1,1,-1,.1,80);Pt.position.set(0,14,0),Pt.up.set(0,0,-1),Pt.lookAt(0,0,0);const Nt=new l2({antialias:!0,alpha:!0});Nt.setPixelRatio(Math.min(window.devicePixelRatio,2)),Nt.outputColorSpace=jn,Nt.toneMapping=Yi,Nt.shadowMap.enabled=!0,Nt.shadowMap.type=Mx,Nt.domElement.style.width="100%",Nt.domElement.style.height="100%",Nt.domElement.style.display="block",Nt.domElement.style.touchAction="manipulation",Nt.domElement.style.userSelect="none",ct.appendChild(Nt.domElement);const ye=new cT(16777215,.85);Ct.add(ye);const De=new lT(16777215,1.1);De.position.set(3,18,-2),De.castShadow=!0,De.shadow.mapSize.width=2048,De.shadow.mapSize.height=2048,De.shadow.camera.near=1,De.shadow.camera.far=40,De.shadow.camera.left=-30,De.shadow.camera.right=30,De.shadow.camera.top=20,De.shadow.camera.bottom=-20,Ct.add(De);const ue=new ji(new Gl(1,1),new N_({color:rx,roughness:.96,metalness:0}));ue.rotation.x=-Math.PI/2,ue.position.y=0,ue.receiveShadow=!0,Ct.add(ue);const ie=new Gb({gravity:new R(0,-40,0),allowSleep:!0});ie.broadphase=new vo(ie),ie.solver.iterations=Ya("normal").solverIterations;const be=new Du("table"),ce=new Du("die"),en=new yo(ce,be,{friction:.24,restitution:Ya("normal").tableRestitution}),X=new yo(ce,ce,{friction:.3,restitution:Ya("normal").diceRestitution});ie.addContactMaterial(en),ie.addContactMaterial(X);const je=new Vt({type:Vt.STATIC,shape:new EE,material:be});je.quaternion.setFromEuler(-Math.PI/2,0,0),ie.addBody(je);const Se=new Yp(Dt,Dt,Dt,6,.16),fe=[];for(let pt=0;pt<c;pt+=1){const ut=jp.map(Qt=>new N_({map:_2(Qt),color:Ld,roughness:.38,metalness:.02})),vt=new ji(Se,ut);vt.castShadow=!0,vt.receiveShadow=!0,vt.userData.dieIndex=pt,Ct.add(vt);const bt=new Vt({mass:1,shape:new gr(new R(nt,nt,nt)),material:ce,sleepSpeedLimit:Ya("normal").sleepSpeedLimit,sleepTimeLimit:Ya("normal").sleepTimeLimit});bt.linearDamping=Ya("normal").linearDamping,bt.angularDamping=Ya("normal").angularDamping,bt.allowSleep=!0,ie.addBody(bt),fe.push({mesh:vt,body:bt,locked:!1})}q.current=fe;const qt=new f2,I=new Set(fe.map(pt=>pt.body)),A=()=>qt.unlock();window.addEventListener("pointerdown",A,{passive:!0}),window.addEventListener("touchstart",A,{passive:!0}),window.addEventListener("click",A,{passive:!0}),fe.forEach(pt=>{pt.body.addEventListener("collide",ut=>{const{body:vt,contact:bt}=ut,Qt=Math.abs(bt.getImpactVelocityAlongNormal());I.has(vt)?qt.playImpact("dice",Qt):qt.playImpact("table",Qt)})});const J=new hT,_t=new Be,Et=pt=>{qt.unlock();const ut=Nt.domElement.getBoundingClientRect();_t.x=(pt.clientX-ut.left)/ut.width*2-1,_t.y=-((pt.clientY-ut.top)/ut.height)*2+1,J.setFromCamera(_t,Pt);const vt=fe.map(Qt=>Qt.mesh),bt=J.intersectObjects(vt,!1);if(bt.length>0){const Xt=bt[0].object.userData.dieIndex;Xt!==void 0&&W(Xt)}};Nt.domElement.addEventListener("pointerdown",Et);let ht={minX:-6,maxX:6,minZ:-3,maxZ:3,depth:6},Wt=[];const Ut=(pt,ut)=>{Wt.forEach(Le=>ie.removeBody(Le)),Wt=[];const vt=new gr(new R(cr/2,Os/2,ut/2)),bt=new gr(new R(pt/2,Os/2,cr/2));[{shape:vt,position:new R(-pt/2-cr/2,Os/2,0)},{shape:vt,position:new R(pt/2+cr/2,Os/2,0)},{shape:bt,position:new R(0,Os/2,-ut/2-cr/2)},{shape:bt,position:new R(0,Os/2,ut/2+cr/2)}].forEach(({shape:Le,position:Zn})=>{const li=new Vt({type:Vt.STATIC,shape:Le,material:be});li.position.copy(Zn),ie.addBody(li),Wt.push(li)});const Xt=Dt*1.8,le=new gr(new R(Xt/2,Os/2,cr/2)),Je=pt/2,Ve=ut/2;[{x:-Je,z:-Ve,angle:Math.PI/4},{x:Je,z:-Ve,angle:-Math.PI/4},{x:-Je,z:Ve,angle:-Math.PI/4},{x:Je,z:Ve,angle:Math.PI/4}].forEach(({x:Le,z:Zn,angle:li})=>{const Hn=new Vt({type:Vt.STATIC,shape:le,material:be});Hn.position.set(Le,Os/2,Zn),Hn.quaternion.setFromEuler(0,li,0),ie.addBody(Hn),Wt.push(Hn)})},Yt=()=>{const pt=ct.clientWidth,ut=ct.clientHeight;if(!pt||!ut)return;const vt=pt/ut,bt=gt,Qt=bt*vt;Pt.left=-Qt,Pt.right=Qt,Pt.top=bt,Pt.bottom=-bt,Pt.updateProjectionMatrix();const Xt=Qt*2,le=bt*2;ue.scale.set(Xt,le,1),ht={minX:-Xt/2,maxX:Xt/2,minZ:-le/2,maxZ:le/2,width:Xt,depth:le},Ut(Xt,le),Nt.setSize(pt,ut,!0),Nt.render(Ct,Pt)},se=new ResizeObserver(Yt);se.observe(ct),Yt();let At=0,wt=0;const Gt=()=>{fe.forEach(pt=>{pt.body.type=Vt.STATIC,pt.body.velocity.setZero(),pt.body.angularVelocity.setZero(),pt.body.position.set(0,-10,0),pt.mesh.position.set(0,-10,0)})},Ft=()=>{if(v.current||P.current>=O.current)return;const pt=Ya(V.current);K.current=pt,ie.solver.iterations=pt.solverIterations,ie.gravity.set(0,pt.gravityY,0),en.restitution=pt.tableRestitution,X.restitution=pt.diceRestitution,qt.unlock(),v.current=!0,M(!0),$.current?.(),At=0,wt=0;const ut=B.current,vt=P.current===0,bt=ht.minX+Dt*.8,Qt=ht.minX+Dt,Xt=ht.maxX-Dt,le=ht.minZ+Dt,Je=ht.maxZ-Dt,Ve=[];let oi=0;fe.forEach((Le,Zn)=>{if(Le.body.sleepSpeedLimit=pt.sleepSpeedLimit,Le.body.sleepTimeLimit=pt.sleepTimeLimit,Le.body.linearDamping=pt.linearDamping,Le.body.angularDamping=pt.angularDamping,!vt&&ut[Zn]){Le.body.type=Vt.STATIC,Le.body.velocity.setZero(),Le.body.angularVelocity.setZero();return}Le.body.type=Vt.DYNAMIC,Le.body.mass=1,Le.body.updateMassProperties(),Le.body.wakeUp(),Le.body.velocity.setZero(),Le.body.angularVelocity.setZero(),Le.body.force.setZero(),Le.body.torque.setZero();const li=.56,Hn=pt.faceUpDrop?y2({minX:Qt,maxX:Xt,minZ:le,maxZ:Je,existing:Ve,minDistance:Dt*.95}):null,ns=pt.faceUpDrop?Hn.x:bt+oi*li+hn(-.1,.1),ci=pt.spawnYBase+oi*pt.spawnYStep,Kn=pt.faceUpDrop?ci+hn(-.6,.8):ci,ln=pt.faceUpDrop?Hn.z:hn(-ht.depth*.25,ht.depth*.25);if(pt.faceUpDrop&&Hn&&Ve.push(Hn),Le.body.position.set(ns,Kn,ln),pt.faceUpDrop)lx(Le.body,x2());else{const fi=new si;fi.setFromEuler(hn(0,Math.PI),hn(0,Math.PI),hn(0,Math.PI),"XYZ"),Le.body.quaternion.copy(fi)}const Sn=pt.faceUpDrop?(()=>{const fi=-ns,Zi=-ln,va=Math.hypot(fi,Zi)||1,is=hn(.9,2.4),Ki=Math.random()<.5?-1:1,Is=Ki*(-Zi/va),Qi=Ki*(fi/va),Oi=hn(.15,1.1),_a=hn(-.45,.45),Ji=hn(-.45,.45);return new R(fi/va*is+Is*Oi+_a,hn(pt.impulseYMin,pt.impulseYMax),Zi/va*is+Qi*Oi+Ji)})():new R(hn(pt.impulseXMin,pt.impulseXMax),hn(pt.impulseYMin,pt.impulseYMax),hn(-1.2,1.2)),ui=new R(hn(-.2,.2),hn(-.08,.08),hn(-.2,.2));Le.body.applyImpulse(Sn,ui),oi++})};g.current=Ft,_.current=Gt,Gt();const Lt=pt=>{if(pt.code!=="Space")return;const ut=pt.target;ut?.tagName==="INPUT"||ut?.tagName==="TEXTAREA"||ut?.isContentEditable||(pt.preventDefault(),Ft())};window.addEventListener("keydown",Lt);const me=new fT,Z=1/60;let Ot=0;const Rt=()=>{const pt=Math.min(me.getDelta(),.04);if(ie.step(Z,pt,4),fe.forEach(ut=>{S2(ut.body,ht,nt),ut.mesh.position.set(ut.body.position.x,ut.body.position.y,ut.body.position.z),ut.mesh.quaternion.set(ut.body.quaternion.x,ut.body.quaternion.y,ut.body.quaternion.z,ut.body.quaternion.w)}),v.current){const ut=K.current;wt+=pt;const vt=B.current,bt=()=>{v.current=!1,M(!1);const Xt=fe.map(Ve=>cx(Ve.body));S(Xt);const le=P.current+1;if(le>=O.current){const Ve=Array(c).fill(!0);L(Ve),B.current=Ve,fe.forEach(oi=>{oi.mesh.material.forEach(Zn=>Zn.color.set(ox))})}U(Ve=>Ve+1);const Je=Xt.reduce((Ve,oi)=>Ve+oi,0);H.current?.({total:Je,values:Xt,attempt:le})};if(ut.maxRollSeconds!=null&&wt>=ut.maxRollSeconds){fe.forEach((Xt,le)=>{vt[le]||(Xt.body.velocity.set(0,0,0),Xt.body.angularVelocity.set(0,0,0),Xt.body.position.y=nt,lx(Xt.body,cx(Xt.body)),Xt.body.sleep(),Xt.mesh.position.set(Xt.body.position.x,Xt.body.position.y,Xt.body.position.z),Xt.mesh.quaternion.set(Xt.body.quaternion.x,Xt.body.quaternion.y,Xt.body.quaternion.z,Xt.body.quaternion.w))}),bt(),At=0,Nt.render(Ct,Pt),Ot=window.requestAnimationFrame(Rt);return}fe.every((Xt,le)=>{if(vt[le]||Xt.body.sleepState===Vt.SLEEPING)return!0;const Je=Xt.body.velocity.lengthSquared()<ut.linearStillThreshold,Ve=Xt.body.angularVelocity.lengthSquared()<ut.angularStillThreshold;return Je&&Ve&&Xt.body.position.y<=nt+.08})?(At+=pt,At>ut.settleHoldSeconds&&bt()):At=0}Nt.render(Ct,Pt),Ot=window.requestAnimationFrame(Rt)};return Rt(),()=>{window.cancelAnimationFrame(Ot),se.disconnect(),window.removeEventListener("keydown",Lt),window.removeEventListener("pointerdown",A),window.removeEventListener("touchstart",A),window.removeEventListener("click",A),Nt.domElement.removeEventListener("pointerdown",Et),qt.dispose(),ct.removeChild(Nt.domElement),Wt.forEach(pt=>ie.removeBody(pt)),ie.removeBody(je),fe.forEach(pt=>{ie.removeBody(pt.body),Ct.remove(pt.mesh)}),ue.geometry.dispose(),ue.material.dispose(),Ct.remove(ue),Se.dispose(),fe.forEach(pt=>{pt.mesh.material.forEach(ut=>{ut.map?.dispose(),ut.dispose()})}),Nt.dispose()}},[c,W]);const Q=b.reduce((ct,Tt)=>ct+Tt,0),mt=T>=w&&!y,yt=!y&&(T<w||o),F=T>=1&&T<w,j=b.map((ct,Tt)=>({value:ct,index:Tt,isLocked:C[Tt]})).sort((ct,Tt)=>ct.value-Tt.value||ct.index-Tt.index);return zt.jsxs("div",{className:"flex h-full w-full flex-col",children:[zt.jsx("div",{className:"relative min-h-0 flex-1 overflow-hidden rounded-none bg-[#1a7a4a]",children:zt.jsx("div",{ref:h,className:"h-full w-full"})}),zt.jsxs("div",{className:"relative flex items-center justify-between px-2 py-0",style:{fontFamily:"'Inter', sans-serif"},children:[zt.jsx("div",{className:"relative flex h-7 items-center gap-2.5",children:b.length>0?zt.jsxs(zt.Fragment,{children:[zt.jsx("div",{className:"flex items-center gap-1",children:j.map(ct=>zt.jsx("button",{type:"button",onClick:()=>F&&W(ct.index),className:`grid h-6 w-6 select-none place-items-center rounded-md border text-[11px] font-bold shadow-sm transition-colors ${ct.isLocked?"border-red-400 bg-red-100 text-red-800":"border-slate-300 bg-white text-slate-800"} ${F?"cursor-pointer touch-manipulation hover:border-slate-400 active:scale-95":""}`,"aria-label":`Die ${ct.index+1}`,children:ct.value},ct.index))}),T>0&&zt.jsx("span",{className:"ml-1 inline-flex h-5 w-[58px] items-center justify-center rounded-full bg-slate-200 px-1 text-[10px] font-bold tabular-nums text-slate-600",children:mt&&!o?"PLACE":`${T} of ${w}`}),zt.jsx("div",{className:"pointer-events-none absolute top-full left-0 mt-0.5 flex items-center gap-2",children:y?zt.jsx("span",{className:"text-[11px] font-medium text-slate-500",children:"Rolling..."}):zt.jsxs(zt.Fragment,{children:[zt.jsx("span",{className:"text-[11px] font-medium text-slate-400",children:"="}),zt.jsx("span",{className:"text-base font-bold leading-none text-slate-800",children:Q})]})})]}):zt.jsxs(zt.Fragment,{children:[zt.jsx("div",{className:"flex items-center gap-1",children:Array.from({length:5}).map((ct,Tt)=>zt.jsx("span",{className:"grid h-6 w-6 place-items-center rounded-md border border-transparent text-[11px]"},Tt))}),zt.jsx("div",{className:"pointer-events-none absolute top-full left-0 mt-0.5 flex items-center gap-2",children:y?zt.jsx("span",{className:"text-[11px] font-medium text-slate-500",children:"Rolling..."}):zt.jsxs(zt.Fragment,{children:[zt.jsx("span",{className:"text-[11px] font-medium text-transparent",children:"="}),zt.jsx("span",{className:"text-base font-bold leading-none text-transparent",children:"00"})]})})]})}),zt.jsx("button",{type:"button",onClick:()=>p?.(f==="fast"?"normal":"fast"),className:"absolute right-[4.5rem] top-1/2 inline-flex h-6 min-w-[58px] -translate-y-1/2 items-center justify-center rounded-full border border-slate-300 bg-white px-3 text-[10px] font-semibold tracking-[0.05em] text-slate-700 uppercase shadow-sm transition-colors hover:border-slate-400 hover:text-slate-900",style:{fontFamily:"'Inter', sans-serif"},"aria-label":`Switch roll speed mode to ${f==="fast"?"slow":"fast"}`,title:`Switch to ${f==="fast"?"SLOW":"FAST"}`,children:f==="fast"?"SLOW":"FAST"}),(!mt||o)&&zt.jsx("button",{"aria-disabled":!yt,onClick:()=>{yt&&(o?G():g.current())},className:`absolute right-2 -top-6 z-20 h-14 w-14 touch-manipulation appearance-none rounded-full border-2 text-center text-[10px] font-bold uppercase tracking-widest shadow-md transition-colors ${yt?"cursor-pointer border-red-600 bg-red-500 text-white hover:bg-red-500":"cursor-not-allowed border-red-300 bg-red-300 text-white"}`,style:{WebkitTapHighlightColor:"transparent",boxShadow:"0 0 0 2px rgba(0,0,0,0.16), 0 8px 16px rgba(0,0,0,0.28)"},children:zt.jsx("span",{className:"text-[11px] font-extrabold",style:{textShadow:"0 1px 1px rgba(0,0,0,0.28)"},children:"PLAY"})})]})]})}function _2(c){const t=document.createElement("canvas");t.width=256,t.height=256;const n=t.getContext("2d");if(!n){const u=new D_(t);return u.colorSpace=jn,u}n.fillStyle="#ffffff",n.fillRect(0,0,t.width,t.height),n.lineWidth=3,n.strokeStyle="#e2e8f0",n.strokeRect(4,4,t.width-8,t.height-8);const a=26,r=g2[c];n.fillStyle="#000000",r.forEach(([u,f])=>{const p=t.width/2+u*112,h=t.height/2+f*112;n.beginPath(),n.arc(p,h,a,0,Math.PI*2),n.fill()});const o=new D_(t);return o.colorSpace=jn,o.anisotropy=4,o.minFilter=Ps,o.magFilter=In,o.needsUpdate=!0,o}function hn(c,t){return c+Math.random()*(t-c)}function x2(){return 1+Math.floor(Math.random()*6)}function y2({minX:c,maxX:t,minZ:n,maxZ:a,existing:r,minDistance:o}){for(let f=0;f<18;f+=1){const p={x:hn(c,t),z:hn(n,a)};if(!r.some(g=>Math.hypot(g.x-p.x,g.z-p.z)<o))return p}return{x:hn(c,t),z:hn(n,a)}}function lx(c,t){const n=jp.indexOf(t),a=ay[n>=0?n:0],r=new lt(a.x,a.y,a.z),o=new lt(0,1,0),u=new xr().setFromUnitVectors(r,o),p=new xr().setFromAxisAngle(o,hn(0,Math.PI*2)).multiply(u);c.quaternion.set(p.x,p.y,p.z,p.w)}function cx(c){const t=jp;let n=-1/0,a=1;const r=new R;for(let o=0;o<6;o++)c.quaternion.vmult(ay[o],r),r.y>n&&(n=r.y,a=t[o]);return a}function S2(c,t,n){const a=t.minX+n,r=t.maxX-n,o=t.minZ+n,u=t.maxZ-n;c.position.x<a?(c.position.x=a,c.velocity.x=Math.abs(c.velocity.x)*.55):c.position.x>r&&(c.position.x=r,c.velocity.x=-Math.abs(c.velocity.x)*.55),c.position.z<o?(c.position.z=o,c.velocity.z=Math.abs(c.velocity.z)*.55):c.position.z>u&&(c.position.z=u,c.velocity.z=-Math.abs(c.velocity.z)*.55)}const Od=["down","up","desordem","seco"],M2=[...hr],E2=[...hr].reverse(),b2={down:{},up:{},desordem:{},seco:{}};function T2(){const[c,t]=we.useState(b2),[n,a]=we.useState(null),[r,o]=we.useState(!1),[u,f]=we.useState(null),[p,h]=we.useState("normal"),g=n?.attempt??0,_=we.useMemo(()=>{const L=["down","up","desordem"].every(P=>hr.every(q=>c[P][q]!=null)),B=hr.some(P=>c.seco[P]==null);return L&&B},[c]),v=we.useMemo(()=>{const C=new Set;for(const L of Od){const B=c[L];if(L==="down"){const P=M2.find(q=>B[q]==null);P&&C.add(`${L}:${P}`);continue}if(L==="up"){const P=E2.find(q=>B[q]==null);P&&C.add(`${L}:${P}`);continue}if(L==="desordem"){hr.forEach(P=>{B[P]==null&&C.add(`${L}:${P}`)});continue}L==="seco"&&g===1&&hr.forEach(P=>{B[P]==null&&C.add(`${L}:${P}`)})}return C},[c,g]),y=we.useMemo(()=>Od.every(C=>hr.every(L=>c[C][L]!=null)),[c]),M=we.useMemo(()=>Od.reduce((C,L)=>C+fx(c[L]).combined,0),[c]),b=we.useCallback(C=>{a(C),o(!0),f(null)},[]),S=we.useCallback(()=>{o(!1),f(null)},[]),x=we.useCallback((C,L)=>{if(!r||!n)return;const B=`${C}:${L}`;if(!v.has(B)||c[C][L]!=null)return;if(u?.columnId===C&&u.rowId===L){f(null);return}const P=A2(L,n.values,c[C]);f({columnId:C,rowId:L,value:P})},[r,v,u,n,c]),T=we.useCallback(()=>{if(!u)return;const{columnId:C,rowId:L,value:B}=u;t(P=>({...P,[C]:{...P[C],[L]:B}})),f(null),o(!1),a(null)},[u]),U=we.useCallback(()=>{t({down:{},up:{},desordem:{},seco:{}}),a(null),o(!1),f(null)},[]);return zt.jsx("main",{className:"min-h-screen touch-manipulation bg-white px-0 py-0 sm:px-8 sm:py-8",children:zt.jsxs("section",{className:"mx-auto flex w-full max-w-[1400px] flex-col gap-0 lg:flex-row lg:items-start lg:gap-8",children:[zt.jsx("div",{className:"order-2 ml-[5px] flex flex-col items-start gap-0 pl-2 lg:order-1 lg:ml-0 lg:shrink-0 lg:items-start lg:gap-5 lg:pl-0",children:zt.jsx(yM,{sheet:c,openCells:v,clickable:r,pendingPlacement:u,onCellClick:x})}),zt.jsx("div",{className:"order-1 min-w-0 flex-1 lg:order-2 lg:sticky lg:top-8 lg:pt-[30px]",children:y?zt.jsxs("div",{className:"flex min-h-[320px] flex-col items-center justify-center gap-6 rounded-3xl border border-[#ccc8c0] bg-[#f7f4ef] px-8 py-10 lg:h-[60vh]",style:{fontFamily:"'Inter', sans-serif"},children:[zt.jsx("p",{className:"text-[11px] font-bold uppercase tracking-[0.22em] text-[#8a8070]",children:"Game Over"}),zt.jsx("p",{className:"text-7xl font-bold leading-none text-[#2d2820]",style:{fontFamily:"'Kalam', cursive"},children:M}),zt.jsx("p",{className:"text-sm text-[#8a8070]",children:"final score"}),zt.jsx("button",{onClick:U,className:"mt-2 rounded-full border border-[#ccc8c0] bg-white px-8 py-2.5 text-xs font-bold uppercase tracking-widest text-[#5a5448] shadow-sm transition hover:bg-[#f0ece4]",children:"New Game"})]}):zt.jsx("div",{className:"h-[24vh] min-h-[150px] min-w-0 sm:h-[34vh] lg:h-[421px]",children:zt.jsx(v2,{diceCount:5,maxAttempts:3,onDiceResult:b,onRollStart:S,forceSingleAttempt:_,hasPendingPlacement:u!=null,onCommitPlacement:T,rollSpeedMode:p,onRollSpeedModeChange:h})})})]})})}function A2(c,t,n){const a=w2(t),r=t.reduce((o,u)=>o+u,0);switch(c){case"ones":return go(a,1);case"twos":return go(a,2);case"threes":return go(a,3);case"fours":return go(a,4);case"fives":return go(a,5);case"sixes":return go(a,6);case"quadra":{const o=a.findIndex((u,f)=>f>0&&u>=4);return o>0?20+4*o:0}case"full":return C2(a)?30+r:0;case"seqLow":return ux(t,[1,2,3,4,5])?35+r:0;case"seqHigh":return ux(t,[2,3,4,5,6])?40+r:0;case"min":{const o=n?.max;return o==null||r<o?r:0}case"max":{const o=n?.min;return o==null||r>o?r:0}case"yam":return R2(a,5)?50+r:0}}function w2(c){const t=Array(7).fill(0);return c.forEach(n=>{n>=1&&n<=6&&(t[n]+=1)}),t}function go(c,t){return c[t]*t}function R2(c,t){return c.some(n=>n===t)}function C2(c){const t=c.filter(n=>n>0);return t.length===2&&t.includes(3)&&t.includes(2)}function ux(c,t){const n=[...new Set(c)].sort((a,r)=>a-r);return n.length!==t.length?!1:t.every((a,r)=>n[r]===a)}_M.createRoot(document.getElementById("root")).render(zt.jsx(we.StrictMode,{children:zt.jsx(T2,{})}));
