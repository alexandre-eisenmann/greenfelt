...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pa,depthTest:!1,depthWrite:!1})}function tR(c,t,n){const a=new Float32Array(nr),r=new lt(0,1,0);return new sa({name:"SphericalGaussianBlur",defines:{n:nr,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${c}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:a},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:zu(),fragmentShader:`
...
}`,GC=[new lt(1,0,0),new lt(-1,0,0),new lt(0,1,0),new lt(0,-1,0),new lt(0,0,1),new lt(0,0,-1)],VC=[new lt(0,-1,0),new lt(0,-1,0),new lt(0,0,1),new lt(0,0,-1),new lt(0,-1,0),new lt(0,-1,0)],ix=new sn,El=new lt,Dd=new lt;function kC(c,t,n){let a=new Xp;const r=new Le,o=new Le,u=new ln,f=new $1,p=new tT,h={},g=n.maxTextureSize,_={[Ts]:ti,[ti]:Ts,[Oa]:Oa},v=new sa({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Le},radius:{value:4}},vertexShader:IC,fragmentShader:HC}),y=v.clone();y.defines.HORIZONTAL_PASS=1;const M=new Ga;M.setAttribute("position",new na(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new Hi(M,v),S=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Mu;let x=this.type;this.render=function(B,P,X){if(S.enabled===!1||S.autoUpdate===!1&&S.needsUpdate===!1||B.length===0)return;B.type===vx&&(ue("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),B.type=Mu);const w=c.getRenderTarget(),O=c.getActiveCubeFace(),G=c.getActiveMipmapLevel(),$=c.state;$.setBlending(Pa),$.buffers.depth.getReversed()===!0?$.buffers.color.setClear(0,0,0,0):$.buffers.color.setClear(1,1,1,1),$.buffers.depth.setTest(!0),$.setScissorTest(!1);const H=x!==this.type;H&&P.traverse(function(j){j.material&&(Array.isArray(j.material)?j.material.forEach(q=>q.needsUpdate=!0):j.material.needsUpdate=!0)});for(let j=0,q=B.length;j<q;j++){const L=B[j],V=L.shadow;if(V===void 0){ue("WebGLShadowMap:",L,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const K=V.getFrameExtents();if(r.multiply(K),o.copy(V.mapSize),(r.x>g||r.y>g)&&(r.x>g&&(o.x=Math.floor(g/K.x),r.x=o.x*K.x,V.mapSize.x=o.x),r.y>g&&(o.y=Math.floor(g/K.y),r.y=o.y*K.y,V.mapSize.y=o.y)),V.map===null||H===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===Tl){if(L.isPointLight){ue("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new ea(r.x,r.y,{format:ho,type:Ia,minFilter:zn,magFilter:zn,generateMipmaps:!1}),V.map.texture.name=L.name+".shadowMap",V.map.depthTexture=new Ul(r.x,r.y,Ji),V.map.depthTexture.name=L.name+".shadowMapDepth",V.map.depthTexture.format=Ha,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=On,V.map.depthTexture.magFilter=On}else{L.isPointLight?(V.map=new Xx(r.x),V.map.depthTexture=new Q1(r.x,ia)):(V.map=new ea(r.x,r.y),V.map.depthTexture=new Ul(r.x,r.y,ia)),V.map.depthTexture.name=L.name+".shadowMap",V.map.depthTexture.format=Ha;const ht=c.state.buffers.depth.getReversed();this.type===Mu?(V.map.depthTexture.compareFunction=ht?Gp:Hp,V.map.depthTexture.minFilter=zn,V.map.depthTexture.magFilter=zn):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=On,V.map.depthTexture.magFilter=On)}V.camera.updateProjectionMatrix()}const ct=V.map.isWebGLCubeRenderTarget?6:1;for(let ht=0;ht<ct;ht++){if(V.map.isWebGLCubeRenderTarget)c.setRenderTarget(V.map,ht),c.clear();else{ht===0&&(c.setRenderTarget(V.map),c.clear());const F=V.getViewport(ht);u.set(o.x*F.x,o.y*F.y,o.x*F.z,o.y*F.w),$.viewport(u)}if(L.isPointLight){const F=V.camera,Y=V.matrix,gt=L.distance||F.far;gt!==F.far&&(F.far=gt,F.updateProjectionMatrix()),El.setFromMatrixPosition(L.matrixWorld),F.position.copy(El),Dd.copy(F.position),Dd.add(GC[ht]),F.up.copy(VC[ht]),F.lookAt(Dd),F.updateMatrixWorld(),Y.makeTranslation(-El.x,-El.y,-El.z),ix.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),V._frustum.setFromProjectionMatrix(ix,F.coordinateSystem,F.reversedDepth)}else V.updateMatrices(L);a=V.getFrustum(),C(P,X,V.camera,L,this.type)}V.isPointLightShadow!==!0&&this.type===Tl&&T(V,X),V.needsUpdate=!1}x=this.type,S.needsUpdate=!1,c.setRenderTarget(w,O,G)};function T(B,P){const X=t.update(b);v.defines.VSM_SAMPLES!==B.blurSamples&&(v.defines.VSM_SAMPLES=B.blurSamples,y.defines.VSM_SAMPLES=B.blurSamples,v.needsUpdate=!0,y.needsUpdate=!0),B.mapPass===null&&(B.mapPass=new ea(r.x,r.y,{format:ho,type:Ia})),v.uniforms.shadow_pass.value=B.map.depthTexture,v.uniforms.resolution.value=B.mapSize,v.uniforms.radius.value=B.radius,c.setRenderTarget(B.mapPass),c.clear(),c.renderBufferDirect(P,null,X,v,b,null),y.uniforms.shadow_pass.value=B.mapPass.texture,y.uniforms.resolution.value=B.mapSize,y.uniforms.radius.value=B.radius,c.setRenderTarget(B.map),c.clear(),c.renderBufferDirect(P,null,X,y,b,null)}function D(B,P,X,w){let O=null;const G=X.isPointLight===!0?B.customDistanceMaterial:B.customDepthMaterial;if(G!==void 0)O=G;else if(O=X.isPointLight===!0?p:f,c.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const $=O.uuid,H=P.uuid;let j=h[$];j===void 0&&(j={},h[$]=j);let q=j[H];q===void 0&&(q=O.clone(),j[H]=q,P.addEventListener("dispose",z)),O=q}if(O.visible=P.visible,O.wireframe=P.wireframe,w===Tl?O.side=P.shadowSide!==null?P.shadowSide:P.side:O.side=P.shadowSide!==null?P.shadowSide:_[P.side],O.alphaMap=P.alphaMap,O.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,O.map=P.map,O.clipShadows=P.clipShadows,O.clippingPlanes=P.clippingPlanes,O.clipIntersection=P.clipIntersection,O.displacementMap=P.displacementMap,O.displacementScale=P.displacementScale,O.displacementBias=P.displacementBias,O.wireframeLinewidth=P.wireframeLinewidth,O.linewidth=P.linewidth,X.isPointLight===!0&&O.isMeshDistanceMaterial===!0){const $=c.properties.get(O);$.light=X}return O}function C(B,P,X,w,O){if(B.visible===!1)return;if(B.layers.test(P.layers)&&(B.isMesh||B.isLine||B.isPoints)&&(B.castShadow||B.receiveShadow&&O===Tl)&&(!B.frustumCulled||a.intersectsObject(B))){B.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,B.matrixWorld);const H=t.update(B),j=B.material;if(Array.isArray(j)){const q=H.groups;for(let L=0,V=q.length;L<V;L++){const K=q[L],ct=j[K.materialIndex];if(ct&&ct.visible){const ht=D(B,ct,w,O);B.onBeforeShadow(c,B,P,X,H,ht,K),c.renderBufferDirect(X,null,H,ht,B,K),B.onAfterShadow(c,B,P,X,H,ht,K)}}}else if(j.visible){const q=D(B,j,w,O);B.onBeforeShadow(c,B,P,X,H,q,null),c.renderBufferDirect(X,null,H,q,B,null),B.onAfterShadow(c,B,P,X,H,q,null)}}const $=B.children;for(let H=0,j=$.length;H<j;H++)C($[H],P,X,w,O)}function z(B){B.target.removeEventListener("dispose",z);for(const X in h){const w=h[X],O=B.target.uuid;O in w&&(w[O].dispose(),delete w[O])}}}const qC={[Pd]:Bd,[Fd]:Gd,[Id]:Vd,[uo]:Hd,[Bd]:Pd,[Gd]:Fd,[Vd]:Id,[Hd]:uo};function XC(c,t){function n(){let Q=!1;const Ut=new ln;let Rt=null;const Bt=new ln(0,0,0,0);return{setMask:function(wt){Rt!==wt&&!Q&&(c.colorMask(wt,wt,wt,wt),Rt=wt)},setLocked:function(wt){Q=wt},setClear:function(wt,Mt,Nt,re,He){He===!0&&(wt*=re,Mt*=re,Nt*=re),Ut.set(wt,Mt,Nt,re),Bt.equals(Ut)===!1&&(c.clearColor(wt,Mt,Nt,re),Bt.copy(Ut))},reset:function(){Q=!1,Rt=null,Bt.set(-1,0,0,0)}}}function a(){let Q=!1,Ut=!1,Rt=null,Bt=null,wt=null;return{setReversed:function(Mt){if(Ut!==Mt){const Nt=t.get("EXT_clip_control");Mt?Nt.clipControlEXT(Nt.LOWER_LEFT_EXT,Nt.ZERO_TO_ONE_EXT):Nt.clipControlEXT(Nt.LOWER_LEFT_EXT,Nt.NEGATIVE_ONE_TO_ONE_EXT),Ut=Mt;const re=wt;wt=null,this.setClear(re)}},getReversed:function(){return Ut},setTest:function(Mt){Mt?dt(c.DEPTH_TEST):Lt(c.DEPTH_TEST)},setMask:function(Mt){Rt!==Mt&&!Q&&(c.depthMask(Mt),Rt=Mt)},setFunc:function(Mt){if(Ut&&(Mt=qC[Mt]),Bt!==Mt){switch(Mt){case Pd:c.depthFunc(c.NEVER);break;case Bd:c.depthFunc(c.ALWAYS);break;case Fd:c.depthFunc(c.LESS);break;case uo:c.depthFunc(c.LEQUAL);break;case Id:c.depthFunc(c.EQUAL);break;case Hd:c.depthFunc(c.GEQUAL);break;case Gd:c.depthFunc(c.GREATER);break;case Vd:c.depthFunc(c.NOTEQUAL);break;default:c.depthFunc(c.LEQUAL)}Bt=Mt}},setLocked:function(Mt){Q=Mt},setClear:function(Mt){wt!==Mt&&(Ut&&(Mt=1-Mt),c.clearDepth(Mt),wt=Mt)},reset:function(){Q=!1,Rt=null,Bt=null,wt=null,Ut=!1}}}function r(){let Q=!1,Ut=null,Rt=null,Bt=null,wt=null,Mt=null,Nt=null,re=null,He=null;return{setTest:function(we){Q||(we?dt(c.STENCIL_TEST):Lt(c.STENCIL_TEST))},setMask:function(we){Ut!==we&&!Q&&(c.stencilMask(we),Ut=we)},setFunc:function(we,Pn,bi){(Rt!==we||Bt!==Pn||wt!==bi)&&(c.stencilFunc(we,Pn,bi),Rt=we,Bt=Pn,wt=bi)},setOp:function(we,Pn,bi){(Mt!==we||Nt!==Pn||re!==bi)&&(c.stencilOp(we,Pn,bi),Mt=we,Nt=Pn,re=bi)},setLocked:function(we){Q=we},setClear:function(we){He!==we&&(c.clearStencil(we),He=we)},reset:function(){Q=!1,Ut=null,Rt=null,Bt=null,wt=null,Mt=null,Nt=null,re=null,He=null}}}const o=new n,u=new a,f=new r,p=new WeakMap,h=new WeakMap;let g={},_={},v=new WeakMap,y=[],M=null,b=!1,S=null,x=null,T=null,D=null,C=null,z=null,B=null,P=new Ue(0,0,0),X=0,w=!1,O=null,G=null,$=null,H=null,j=null;const q=c.getParameter(c.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let L=!1,V=0;const K=c.getParameter(c.VERSION);K.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(K)[1]),L=V>=1):K.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),L=V>=2);let ct=null,ht={};const F=c.getParameter(c.SCISSOR_BOX),Y=c.getParameter(c.VIEWPORT),gt=new ln().fromArray(F),Tt=new ln().fromArray(Y);function It(Q,Ut,Rt,Bt){const wt=new Uint8Array(4),Mt=c.createTexture();c.bindTexture(Q,Mt),c.texParameteri(Q,c.TEXTURE_MIN_FILTER,c.NEAREST),c.texParameteri(Q,c.TEXTURE_MAG_FILTER,c.NEAREST);for(let Nt=0;Nt<Rt;Nt++)Q===c.TEXTURE_3D||Q===c.TEXTURE_2D_ARRAY?c.texImage3D(Ut,0,c.RGBA,1,1,Bt,0,c.RGBA,c.UNSIGNED_BYTE,wt):c.texImage2D(Ut+Nt,0,c.RGBA,1,1,0,c.RGBA,c.UNSIGNED_BYTE,wt);return Mt}const it={};it[c.TEXTURE_2D]=It(c.TEXTURE_2D,c.TEXTURE_2D,1),it[c.TEXTURE_CUBE_MAP]=It(c.TEXTURE_CUBE_MAP,c.TEXTURE_CUBE_MAP_POSITIVE_X,6),it[c.TEXTURE_2D_ARRAY]=It(c.TEXTURE_2D_ARRAY,c.TEXTURE_2D_ARRAY,1,1),it[c.TEXTURE_3D]=It(c.TEXTURE_3D,c.TEXTURE_3D,1,1),o.setClear(0,0,0,1),u.setClear(1),f.setClear(0),dt(c.DEPTH_TEST),u.setFunc(uo),se(!1),We(i_),dt(c.CULL_FACE),he(Pa);function dt(Q){g[Q]!==!0&&(c.enable(Q),g[Q]=!0)}function Lt(Q){g[Q]!==!1&&(c.disable(Q),g[Q]=!1)}function Ht(Q,Ut){return _[Q]!==Ut?(c.bindFramebuffer(Q,Ut),_[Q]=Ut,Q===c.DRAW_FRAMEBUFFER&&(_[c.FRAMEBUFFER]=Ut),Q===c.FRAMEBUFFER&&(_[c.DRAW_FRAMEBUFFER]=Ut),!0):!1}function qt(Q,Ut){let Rt=y,Bt=!1;if(Q){Rt=v.get(Ut),Rt===void 0&&(Rt=[],v.set(Ut,Rt));const wt=Q.textures;if(Rt.length!==wt.length||Rt[0]!==c.COLOR_ATTACHMENT0){for(let Mt=0,Nt=wt.length;Mt<Nt;Mt++)Rt[Mt]=c.COLOR_ATTACHMENT0+Mt;Rt.length=wt.length,Bt=!0}}else Rt[0]!==c.BACK&&(Rt[0]=c.BACK,Bt=!0);Bt&&c.drawBuffers(Rt)}function ge(Q){return M!==Q?(c.useProgram(Q),M=Q,!0):!1}const Ie={[er]:c.FUNC_ADD,[Wb]:c.FUNC_SUBTRACT,[Yb]:c.FUNC_REVERSE_SUBTRACT};Ie[jb]=c.MIN,Ie[Zb]=c.MAX;const ve={[Kb]:c.ZERO,[Qb]:c.ONE,[Jb]:c.SRC_COLOR,[Od]:c.SRC_ALPHA,[a1]:c.SRC_ALPHA_SATURATE,[n1]:c.DST_COLOR,[t1]:c.DST_ALPHA,[$b]:c.ONE_MINUS_SRC_COLOR,[zd]:c.ONE_MINUS_SRC_ALPHA,[i1]:c.ONE_MINUS_DST_COLOR,[e1]:c.ONE_MINUS_DST_ALPHA,[s1]:c.CONSTANT_COLOR,[r1]:c.ONE_MINUS_CONSTANT_COLOR,[o1]:c.CONSTANT_ALPHA,[l1]:c.ONE_MINUS_CONSTANT_ALPHA};function he(Q,Ut,Rt,Bt,wt,Mt,Nt,re,He,we){if(Q===Pa){b===!0&&(Lt(c.BLEND),b=!1);return}if(b===!1&&(dt(c.BLEND),b=!0),Q!==Xb){if(Q!==S||we!==w){if((x!==er||C!==er)&&(c.blendEquation(c.FUNC_ADD),x=er,C=er),we)switch(Q){case oo:c.blendFuncSeparate(c.ONE,c.ONE_MINUS_SRC_ALPHA,c.ONE,c.ONE_MINUS_SRC_ALPHA);break;case a_:c.blendFunc(c.ONE,c.ONE);break;case s_:c.blendFuncSeparate(c.ZERO,c.ONE_MINUS_SRC_COLOR,c.ZERO,c.ONE);break;case r_:c.blendFuncSeparate(c.DST_COLOR,c.ONE_MINUS_SRC_ALPHA,c.ZERO,c.ONE);break;default:Re("WebGLState: Invalid blending: ",Q);break}else switch(Q){case oo:c.blendFuncSeparate(c.SRC_ALPHA,c.ONE_MINUS_SRC_ALPHA,c.ONE,c.ONE_MINUS_SRC_ALPHA);break;case a_:c.blendFuncSeparate(c.SRC_ALPHA,c.ONE,c.ONE,c.ONE);break;case s_:Re("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case r_:Re("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Re("WebGLState: Invalid blending: ",Q);break}T=null,D=null,z=null,B=null,P.set(0,0,0),X=0,S=Q,w=we}return}wt=wt||Ut,Mt=Mt||Rt,Nt=Nt||Bt,(Ut!==x||wt!==C)&&(c.blendEquationSeparate(Ie[Ut],Ie[wt]),x=Ut,C=wt),(Rt!==T||Bt!==D||Mt!==z||Nt!==B)&&(c.blendFuncSeparate(ve[Rt],ve[Bt],ve[Mt],ve[Nt]),T=Rt,D=Bt,z=Mt,B=Nt),(re.equals(P)===!1||He!==X)&&(c.blendColor(re.r,re.g,re.b,He),P.copy(re),X=He),S=Q,w=!1}function Ae(Q,Ut){Q.side===Oa?Lt(c.CULL_FACE):dt(c.CULL_FACE);let Rt=Q.side===ti;Ut&&(Rt=!Rt),se(Rt),Q.blending===oo&&Q.transparent===!1?he(Pa):he(Q.blending,Q.blendEquation,Q.blendSrc,Q.blendDst,Q.blendEquationAlpha,Q.blendSrcAlpha,Q.blendDstAlpha,Q.blendColor,Q.blendAlpha,Q.premultipliedAlpha),u.setFunc(Q.depthFunc),u.setTest(Q.depthTest),u.setMask(Q.depthWrite),o.setMask(Q.colorWrite);const Bt=Q.stencilWrite;f.setTest(Bt),Bt&&(f.setMask(Q.stencilWriteMask),f.setFunc(Q.stencilFunc,Q.stencilRef,Q.stencilFuncMask),f.setOp(Q.stencilFail,Q.stencilZFail,Q.stencilZPass)),Ke(Q.polygonOffset,Q.polygonOffsetFactor,Q.polygonOffsetUnits),Q.alphaToCoverage===!0?dt(c.SAMPLE_ALPHA_TO_COVERAGE):Lt(c.SAMPLE_ALPHA_TO_COVERAGE)}function se(Q){O!==Q&&(Q?c.frontFace(c.CW):c.frontFace(c.CCW),O=Q)}function We(Q){Q!==kb?(dt(c.CULL_FACE),Q!==G&&(Q===i_?c.cullFace(c.BACK):Q===qb?c.cullFace(c.FRONT):c.cullFace(c.FRONT_AND_BACK))):Lt(c.CULL_FACE),G=Q}function W(Q){Q!==$&&(L&&c.lineWidth(Q),$=Q)}function Ke(Q,Ut,Rt){Q?(dt(c.POLYGON_OFFSET_FILL),(H!==Ut||j!==Rt)&&(c.polygonOffset(Ut,Rt),H=Ut,j=Rt)):Lt(c.POLYGON_OFFSET_FILL)}function _e(Q){Q?dt(c.SCISSOR_TEST):Lt(c.SCISSOR_TEST)}function Ee(Q){Q===void 0&&(Q=c.TEXTURE0+q-1),ct!==Q&&(c.activeTexture(Q),ct=Q)}function Zt(Q,Ut,Rt){Rt===void 0&&(ct===null?Rt=c.TEXTURE0+q-1:Rt=ct);let Bt=ht[Rt];Bt===void 0&&(Bt={type:void 0,texture:void 0},ht[Rt]=Bt),(Bt.type!==Q||Bt.texture!==Ut)&&(ct!==Rt&&(c.activeTexture(Rt),ct=Rt),c.bindTexture(Q,Ut||it[Q]),Bt.type=Q,Bt.texture=Ut)}function I(){const Q=ht[ct];Q!==void 0&&Q.type!==void 0&&(c.bindTexture(Q.type,null),Q.type=void 0,Q.texture=void 0)}function A(){try{c.compressedTexImage2D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function J(){try{c.compressedTexImage3D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function _t(){try{c.texSubImage2D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function bt(){try{c.texSubImage3D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function pt(){try{c.compressedTexSubImage2D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function At(){try{c.compressedTexSubImage3D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function xt(){try{c.texStorage2D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function Ot(){try{c.texStorage3D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function zt(){try{c.texImage2D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function mt(){try{c.texImage3D(...arguments)}catch(Q){Re("WebGLState:",Q)}}function Et(Q){gt.equals(Q)===!1&&(c.scissor(Q.x,Q.y,Q.z,Q.w),gt.copy(Q))}function Dt(Q){Tt.equals(Q)===!1&&(c.viewport(Q.x,Q.y,Q.z,Q.w),Tt.copy(Q))}function Pt(Q,Ut){let Rt=h.get(Ut);Rt===void 0&&(Rt=new WeakMap,h.set(Ut,Rt));let Bt=Rt.get(Q);Bt===void 0&&(Bt=c.getUniformBlockIndex(Ut,Q.name),Rt.set(Q,Bt))}function Ct(Q,Ut){const Bt=h.get(Ut).get(Q);p.get(Ut)!==Bt&&(c.uniformBlockBinding(Ut,Bt,Q.__bindingPointIndex),p.set(Ut,Bt))}function oe(){c.disable(c.BLEND),c.disable(c.CULL_FACE),c.disable(c.DEPTH_TEST),c.disable(c.POLYGON_OFFSET_FILL),c.disable(c.SCISSOR_TEST),c.disable(c.STENCIL_TEST),c.disable(c.SAMPLE_ALPHA_TO_COVERAGE),c.blendEquation(c.FUNC_ADD),c.blendFunc(c.ONE,c.ZERO),c.blendFuncSeparate(c.ONE,c.ZERO,c.ONE,c.ZERO),c.blendColor(0,0,0,0),c.colorMask(!0,!0,!0,!0),c.clearColor(0,0,0,0),c.depthMask(!0),c.depthFunc(c.LESS),u.setReversed(!1),c.clearDepth(1),c.stencilMask(4294967295),c.stencilFunc(c.ALWAYS,0,4294967295),c.stencilOp(c.KEEP,c.KEEP,c.KEEP),c.clearStencil(0),c.cullFace(c.BACK),c.frontFace(c.CCW),c.polygonOffset(0,0),c.activeTexture(c.TEXTURE0),c.bindFramebuffer(c.FRAMEBUFFER,null),c.bindFramebuffer(c.DRAW_FRAMEBUFFER,null),c.bindFramebuffer(c.READ_FRAMEBUFFER,null),c.useProgram(null),c.lineWidth(1),c.scissor(0,0,c.canvas.width,c.canvas.height),c.viewport(0,0,c.canvas.width,c.canvas.height),g={},ct=null,ht={},_={},v=new WeakMap,y=[],M=null,b=!1,S=null,x=null,T=null,D=null,C=null,z=null,B=null,P=new Ue(0,0,0),X=0,w=!1,O=null,G=null,$=null,H=null,j=null,gt.set(0,0,c.canvas.width,c.canvas.height),Tt.set(0,0,c.canvas.width,c.canvas.height),o.reset(),u.reset(),f.reset()}return{buffers:{color:o,depth:u,stencil:f},enable:dt,disable:Lt,bindFramebuffer:Ht,drawBuffers:qt,useProgram:ge,setBlending:he,setMaterial:Ae,setFlipSided:se,setCullFace:We,setLineWidth:W,setPolygonOffset:Ke,setScissorTest:_e,activeTexture:Ee,bindTexture:Zt,unbindTexture:I,compressedTexImage2D:A,compressedTexImage3D:J,texImage2D:zt,texImage3D:mt,updateUBOMapping:Pt,uniformBlockBinding:Ct,texStorage2D:xt,texStorage3D:Ot,texSubImage2D:_t,texSubImage3D:bt,compressedTexSubImage2D:pt,compressedTexSubImage3D:At,scissor:Et,viewport:Dt,reset:oe}}function WC(c,t,n,a,r,o,u){const f=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Le,g=new WeakMap;let _;const v=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(I,A){return y?new OffscreenCanvas(I,A):Uu("canvas")}function b(I,A,J){let _t=1;const bt=Zt(I);if((bt.width>J||bt.height>J)&&(_t=J/Math.max(bt.width,bt.height)),_t<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const pt=Math.floor(_t*bt.width),At=Math.floor(_t*bt.height);_===void 0&&(_=M(pt,At));const xt=A?M(pt,At):_;return xt.width=pt,xt.height=At,xt.getContext("2d").drawImage(I,0,0,pt,At),ue("WebGLRenderer: Texture has been resized from ("+bt.width+"x"+bt.height+") to ("+pt+"x"+At+")."),xt}else return"data"in I&&ue("WebGLRenderer: Image in DataTexture is too big ("+bt.width+"x"+bt.height+")."),I;return I}function S(I){return I.generateMipmaps}function x(I){c.generateMipmap(I)}function T(I){return I.isWebGLCubeRenderTarget?c.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?c.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?c.TEXTURE_2D_ARRAY:c.TEXTURE_2D}function D(I,A,J,_t,bt=!1){if(I!==null){if(c[I]!==void 0)return c[I];ue("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let pt=A;if(A===c.RED&&(J===c.FLOAT&&(pt=c.R32F),J===c.HALF_FLOAT&&(pt=c.R16F),J===c.UNSIGNED_BYTE&&(pt=c.R8)),A===c.RED_INTEGER&&(J===c.UNSIGNED_BYTE&&(pt=c.R8UI),J===c.UNSIGNED_SHORT&&(pt=c.R16UI),J===c.UNSIGNED_INT&&(pt=c.R32UI),J===c.BYTE&&(pt=c.R8I),J===c.SHORT&&(pt=c.R16I),J===c.INT&&(pt=c.R32I)),A===c.RG&&(J===c.FLOAT&&(pt=c.RG32F),J===c.HALF_FLOAT&&(pt=c.RG16F),J===c.UNSIGNED_BYTE&&(pt=c.RG8)),A===c.RG_INTEGER&&(J===c.UNSIGNED_BYTE&&(pt=c.RG8UI),J===c.UNSIGNED_SHORT&&(pt=c.RG16UI),J===c.UNSIGNED_INT&&(pt=c.RG32UI),J===c.BYTE&&(pt=c.RG8I),J===c.SHORT&&(pt=c.RG16I),J===c.INT&&(pt=c.RG32I)),A===c.RGB_INTEGER&&(J===c.UNSIGNED_BYTE&&(pt=c.RGB8UI),J===c.UNSIGNED_SHORT&&(pt=c.RGB16UI),J===c.UNSIGNED_INT&&(pt=c.RGB32UI),J===c.BYTE&&(pt=c.RGB8I),J===c.SHORT&&(pt=c.RGB16I),J===c.INT&&(pt=c.RGB32I)),A===c.RGBA_INTEGER&&(J===c.UNSIGNED_BYTE&&(pt=c.RGBA8UI),J===c.UNSIGNED_SHORT&&(pt=c.RGBA16UI),J===c.UNSIGNED_INT&&(pt=c.RGBA32UI),J===c.BYTE&&(pt=c.RGBA8I),J===c.SHORT&&(pt=c.RGBA16I),J===c.INT&&(pt=c.RGBA32I)),A===c.RGB&&(J===c.UNSIGNED_INT_5_9_9_9_REV&&(pt=c.RGB9_E5),J===c.UNSIGNED_INT_10F_11F_11F_REV&&(pt=c.R11F_G11F_B10F)),A===c.RGBA){const At=bt?Du:Ce.getTransfer(_t);J===c.FLOAT&&(pt=c.RGBA32F),J===c.HALF_FLOAT&&(pt=c.RGBA16F),J===c.UNSIGNED_BYTE&&(pt=At===qe?c.SRGB8_ALPHA8:c.RGBA8),J===c.UNSIGNED_SHORT_4_4_4_4&&(pt=c.RGBA4),J===c.UNSIGNED_SHORT_5_5_5_1&&(pt=c.RGB5_A1)}return(pt===c.R16F||pt===c.R32F||pt===c.RG16F||pt===c.RG32F||pt===c.RGBA16F||pt===c.RGBA32F)&&t.get("EXT_color_buffer_float"),pt}function C(I,A){let J;return I?A===null||A===ia||A===Dl?J=c.DEPTH24_STENCIL8:A===Ji?J=c.DEPTH32F_STENCIL8:A===Cl&&(J=c.DEPTH24_STENCIL8,ue("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):A===null||A===ia||A===Dl?J=c.DEPTH_COMPONENT24:A===Ji?J=c.DEPTH_COMPONENT32F:A===Cl&&(J=c.DEPTH_COMPONENT16),J}function z(I,A){return S(I)===!0||I.isFramebufferTexture&&I.minFilter!==On&&I.minFilter!==zn?Math.log2(Math.max(A.width,A.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?A.mipmaps.length:1}function B(I){const A=I.target;A.removeEventListener("dispose",B),X(A),A.isVideoTexture&&g.delete(A)}function P(I){const A=I.target;A.removeEventListener("dispose",P),O(A)}function X(I){const A=a.get(I);if(A.__webglInit===void 0)return;const J=I.source,_t=v.get(J);if(_t){const bt=_t[A.__cacheKey];bt.usedTimes--,bt.usedTimes===0&&w(I),Object.keys(_t).length===0&&v.delete(J)}a.remove(I)}function w(I){const A=a.get(I);c.deleteTexture(A.__webglTexture);const J=I.source,_t=v.get(J);delete _t[A.__cacheKey],u.memory.textures--}function O(I){const A=a.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),a.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let _t=0;_t<6;_t++){if(Array.isArray(A.__webglFramebuffer[_t]))for(let bt=0;bt<A.__webglFramebuffer[_t].length;bt++)c.deleteFramebuffer(A.__webglFramebuffer[_t][bt]);else c.deleteFramebuffer(A.__webglFramebuffer[_t]);A.__webglDepthbuffer&&c.deleteRenderbuffer(A.__webglDepthbuffer[_t])}else{if(Array.isArray(A.__webglFramebuffer))for(let _t=0;_t<A.__webglFramebuffer.length;_t++)c.deleteFramebuffer(A.__webglFramebuffer[_t]);else c.deleteFramebuffer(A.__webglFramebuffer);if(A.__webglDepthbuffer&&c.deleteRenderbuffer(A.__webglDepthbuffer),A.__webglMultisampledFramebuffer&&c.deleteFramebuffer(A.__webglMultisampledFramebuffer),A.__webglColorRenderbuffer)for(let _t=0;_t<A.__webglColorRenderbuffer.length;_t++)A.__webglColorRenderbuffer[_t]&&c.deleteRenderbuffer(A.__webglColorRenderbuffer[_t]);A.__webglDepthRenderbuffer&&c.deleteRenderbuffer(A.__webglDepthRenderbuffer)}const J=I.textures;for(let _t=0,bt=J.length;_t<bt;_t++){const pt=a.get(J[_t]);pt.__webglTexture&&(c.deleteTexture(pt.__webglTexture),u.memory.textures--),a.remove(J[_t])}a.remove(I)}let G=0;function $(){G=0}function H(){const I=G;return I>=r.maxTextures&&ue("WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+r.maxTextures),G+=1,I}function j(I){const A=[];return A.push(I.wrapS),A.push(I.wrapT),A.push(I.wrapR||0),A.push(I.magFilter),A.push(I.minFilter),A.push(I.anisotropy),A.push(I.internalFormat),A.push(I.format),A.push(I.type),A.push(I.generateMipmaps),A.push(I.premultiplyAlpha),A.push(I.flipY),A.push(I.unpackAlignment),A.push(I.colorSpace),A.join()}function q(I,A){const J=a.get(I);if(I.isVideoTexture&&_e(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&J.__version!==I.version){const _t=I.image;if(_t===null)ue("WebGLRenderer: Texture marked for update but no image data found.");else if(_t.complete===!1)ue("WebGLRenderer: Texture marked for update but image is incomplete");else{it(J,I,A);return}}else I.isExternalTexture&&(J.__webglTexture=I.sourceTexture?I.sourceTexture:null);n.bindTexture(c.TEXTURE_2D,J.__webglTexture,c.TEXTURE0+A)}function L(I,A){const J=a.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&J.__version!==I.version){it(J,I,A);return}else I.isExternalTexture&&(J.__webglTexture=I.sourceTexture?I.sourceTexture:null);n.bindTexture(c.TEXTURE_2D_ARRAY,J.__webglTexture,c.TEXTURE0+A)}function V(I,A){const J=a.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&J.__version!==I.version){it(J,I,A);return}n.bindTexture(c.TEXTURE_3D,J.__webglTexture,c.TEXTURE0+A)}function K(I,A){const J=a.get(I);if(I.isCubeDepthTexture!==!0&&I.version>0&&J.__version!==I.version){dt(J,I,A);return}n.bindTexture(c.TEXTURE_CUBE_MAP,J.__webglTexture,c.TEXTURE0+A)}const ct={[Xd]:c.REPEAT,[za]:c.CLAMP_TO_EDGE,[Wd]:c.MIRRORED_REPEAT},ht={[On]:c.NEAREST,[f1]:c.NEAREST_MIPMAP_NEAREST,[eu]:c.NEAREST_MIPMAP_LINEAR,[zn]:c.LINEAR,[$h]:c.LINEAR_MIPMAP_NEAREST,[Es]:c.LINEAR_MIPMAP_LINEAR},F={[p1]:c.NEVER,[x1]:c.ALWAYS,[m1]:c.LESS,[Hp]:c.LEQUAL,[g1]:c.EQUAL,[Gp]:c.GEQUAL,[v1]:c.GREATER,[_1]:c.NOTEQUAL};function Y(I,A){if(A.type===Ji&&t.has("OES_texture_float_linear")===!1&&(A.magFilter===zn||A.magFilter===$h||A.magFilter===eu||A.magFilter===Es||A.minFilter===zn||A.minFilter===$h||A.minFilter===eu||A.minFilter===Es)&&ue("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),c.texParameteri(I,c.TEXTURE_WRAP_S,ct[A.wrapS]),c.texParameteri(I,c.TEXTURE_WRAP_T,ct[A.wrapT]),(I===c.TEXTURE_3D||I===c.TEXTURE_2D_ARRAY)&&c.texParameteri(I,c.TEXTURE_WRAP_R,ct[A.wrapR]),c.texParameteri(I,c.TEXTURE_MAG_FILTER,ht[A.magFilter]),c.texParameteri(I,c.TEXTURE_MIN_FILTER,ht[A.minFilter]),A.compareFunction&&(c.texParameteri(I,c.TEXTURE_COMPARE_MODE,c.COMPARE_REF_TO_TEXTURE),c.texParameteri(I,c.TEXTURE_COMPARE_FUNC,F[A.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(A.magFilter===On||A.minFilter!==eu&&A.minFilter!==Es||A.type===Ji&&t.has("OES_texture_float_linear")===!1)return;if(A.anisotropy>1||a.get(A).__currentAnisotropy){const J=t.get("EXT_texture_filter_anisotropic");c.texParameterf(I,J.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,r.getMaxAnisotropy())),a.get(A).__currentAnisotropy=A.anisotropy}}}function gt(I,A){let J=!1;I.__webglInit===void 0&&(I.__webglInit=!0,A.addEventListener("dispose",B));const _t=A.source;let bt=v.get(_t);bt===void 0&&(bt={},v.set(_t,bt));const pt=j(A);if(pt!==I.__cacheKey){bt[pt]===void 0&&(bt[pt]={texture:c.createTexture(),usedTimes:0},u.memory.textures++,J=!0),bt[pt].usedTimes++;const At=bt[I.__cacheKey];At!==void 0&&(bt[I.__cacheKey].usedTimes--,At.usedTimes===0&&w(A)),I.__cacheKey=pt,I.__webglTexture=bt[pt].texture}return J}function Tt(I,A,J){return Math.floor(Math.floor(I/J)/A)}function It(I,A,J,_t){const pt=I.updateRanges;if(pt.length===0)n.texSubImage2D(c.TEXTURE_2D,0,0,0,A.width,A.height,J,_t,A.data);else{pt.sort((mt,Et)=>mt.start-Et.start);let At=0;for(let mt=1;mt<pt.length;mt++){const Et=pt[At],Dt=pt[mt],Pt=Et.start+Et.count,Ct=Tt(Dt.start,A.width,4),oe=Tt(Et.start,A.width,4);Dt.start<=Pt+1&&Ct===oe&&Tt(Dt.start+Dt.count-1,A.width,4)===Ct?Et.count=Math.max(Et.count,Dt.start+Dt.count-Et.start):(++At,pt[At]=Dt)}pt.length=At+1;const xt=c.getParameter(c.UNPACK_ROW_LENGTH),Ot=c.getParameter(c.UNPACK_SKIP_PIXELS),zt=c.getParameter(c.UNPACK_SKIP_ROWS);c.pixelStorei(c.UNPACK_ROW_LENGTH,A.width);for(let mt=0,Et=pt.length;mt<Et;mt++){const Dt=pt[mt],Pt=Math.floor(Dt.start/4),Ct=Math.ceil(Dt.count/4),oe=Pt%A.width,Q=Math.floor(Pt/A.width),Ut=Ct,Rt=1;c.pixelStorei(c.UNPACK_SKIP_PIXELS,oe),c.pixelStorei(c.UNPACK_SKIP_ROWS,Q),n.texSubImage2D(c.TEXTURE_2D,0,oe,Q,Ut,Rt,J,_t,A.data)}I.clearUpdateRanges(),c.pixelStorei(c.UNPACK_ROW_LENGTH,xt),c.pixelStorei(c.UNPACK_SKIP_PIXELS,Ot),c.pixelStorei(c.UNPACK_SKIP_ROWS,zt)}}function it(I,A,J){let _t=c.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&(_t=c.TEXTURE_2D_ARRAY),A.isData3DTexture&&(_t=c.TEXTURE_3D);const bt=gt(I,A),pt=A.source;n.bindTexture(_t,I.__webglTexture,c.TEXTURE0+J);const At=a.get(pt);if(pt.version!==At.__version||bt===!0){n.activeTexture(c.TEXTURE0+J);const xt=Ce.getPrimaries(Ce.workingColorSpace),Ot=A.colorSpace===Ms?null:Ce.getPrimaries(A.colorSpace),zt=A.colorSpace===Ms||xt===Ot?c.NONE:c.BROWSER_DEFAULT_WEBGL;c.pixelStorei(c.UNPACK_FLIP_Y_WEBGL,A.flipY),c.pixelStorei(c.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),c.pixelStorei(c.UNPACK_ALIGNMENT,A.unpackAlignment),c.pixelStorei(c.UNPACK_COLORSPACE_CONVERSION_WEBGL,zt);let mt=b(A.image,!1,r.maxTextureSize);mt=Ee(A,mt);const Et=o.convert(A.format,A.colorSpace),Dt=o.convert(A.type);let Pt=D(A.internalFormat,Et,Dt,A.colorSpace,A.isVideoTexture);Y(_t,A);let Ct;const oe=A.mipmaps,Q=A.isVideoTexture!==!0,Ut=At.__version===void 0||bt===!0,Rt=pt.dataReady,Bt=z(A,mt);if(A.isDepthTexture)Pt=C(A.format===ar,A.type),Ut&&(Q?n.texStorage2D(c.TEXTURE_2D,1,Pt,mt.width,mt.height):n.texImage2D(c.TEXTURE_2D,0,Pt,mt.width,mt.height,0,Et,Dt,null));else if(A.isDataTexture)if(oe.length>0){Q&&Ut&&n.texStorage2D(c.TEXTURE_2D,Bt,Pt,oe[0].width,oe[0].height);for(let wt=0,Mt=oe.length;wt<Mt;wt++)Ct=oe[wt],Q?Rt&&n.texSubImage2D(c.TEXTURE_2D,wt,0,0,Ct.width,Ct.height,Et,Dt,Ct.data):n.texImage2D(c.TEXTURE_2D,wt,Pt,Ct.width,Ct.height,0,Et,Dt,Ct.data);A.generateMipmaps=!1}else Q?(Ut&&n.texStorage2D(c.TEXTURE_2D,Bt,Pt,mt.width,mt.height),Rt&&It(A,mt,Et,Dt)):n.texImage2D(c.TEXTURE_2D,0,Pt,mt.width,mt.height,0,Et,Dt,mt.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){Q&&Ut&&n.texStorage3D(c.TEXTURE_2D_ARRAY,Bt,Pt,oe[0].width,oe[0].height,mt.depth);for(let wt=0,Mt=oe.length;wt<Mt;wt++)if(Ct=oe[wt],A.format!==Fi)if(Et!==null)if(Q){if(Rt)if(A.layerUpdates.size>0){const Nt=O_(Ct.width,Ct.height,A.format,A.type);for(const re of A.layerUpdates){const He=Ct.data.subarray(re*Nt/Ct.data.BYTES_PER_ELEMENT,(re+1)*Nt/Ct.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(c.TEXTURE_2D_ARRAY,wt,0,0,re,Ct.width,Ct.height,1,Et,He)}A.clearLayerUpdates()}else n.compressedTexSubImage3D(c.TEXTURE_2D_ARRAY,wt,0,0,0,Ct.width,Ct.height,mt.depth,Et,Ct.data)}else n.compressedTexImage3D(c.TEXTURE_2D_ARRAY,wt,Pt,Ct.width,Ct.height,mt.depth,0,Ct.data,0,0);else ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Q?Rt&&n.texSubImage3D(c.TEXTURE_2D_ARRAY,wt,0,0,0,Ct.width,Ct.height,mt.depth,Et,Dt,Ct.data):n.texImage3D(c.TEXTURE_2D_ARRAY,wt,Pt,Ct.width,Ct.height,mt.depth,0,Et,Dt,Ct.data)}else{Q&&Ut&&n.texStorage2D(c.TEXTURE_2D,Bt,Pt,oe[0].width,oe[0].height);for(let wt=0,Mt=oe.length;wt<Mt;wt++)Ct=oe[wt],A.format!==Fi?Et!==null?Q?Rt&&n.compressedTexSubImage2D(c.TEXTURE_2D,wt,0,0,Ct.width,Ct.height,Et,Ct.data):n.compressedTexImage2D(c.TEXTURE_2D,wt,Pt,Ct.width,Ct.height,0,Ct.data):ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Q?Rt&&n.texSubImage2D(c.TEXTURE_2D,wt,0,0,Ct.width,Ct.height,Et,Dt,Ct.data):n.texImage2D(c.TEXTURE_2D,wt,Pt,Ct.width,Ct.height,0,Et,Dt,Ct.data)}else if(A.isDataArrayTexture)if(Q){if(Ut&&n.texStorage3D(c.TEXTURE_2D_ARRAY,Bt,Pt,mt.width,mt.height,mt.depth),Rt)if(A.layerUpdates.size>0){const wt=O_(mt.width,mt.height,A.format,A.type);for(const Mt of A.layerUpdates){const Nt=mt.data.subarray(Mt*wt/mt.data.BYTES_PER_ELEMENT,(Mt+1)*wt/mt.data.BYTES_PER_ELEMENT);n.texSubImage3D(c.TEXTURE_2D_ARRAY,0,0,0,Mt,mt.width,mt.height,1,Et,Dt,Nt)}A.clearLayerUpdates()}else n.texSubImage3D(c.TEXTURE_2D_ARRAY,0,0,0,0,mt.width,mt.height,mt.depth,Et,Dt,mt.data)}else n.texImage3D(c.TEXTURE_2D_ARRAY,0,Pt,mt.width,mt.height,mt.depth,0,Et,Dt,mt.data);else if(A.isData3DTexture)Q?(Ut&&n.texStorage3D(c.TEXTURE_3D,Bt,Pt,mt.width,mt.height,mt.depth),Rt&&n.texSubImage3D(c.TEXTURE_3D,0,0,0,0,mt.width,mt.height,mt.depth,Et,Dt,mt.data)):n.texImage3D(c.TEXTURE_3D,0,Pt,mt.width,mt.height,mt.depth,0,Et,Dt,mt.data);else if(A.isFramebufferTexture){if(Ut)if(Q)n.texStorage2D(c.TEXTURE_2D,Bt,Pt,mt.width,mt.height);else{let wt=mt.width,Mt=mt.height;for(let Nt=0;Nt<Bt;Nt++)n.texImage2D(c.TEXTURE_2D,Nt,Pt,wt,Mt,0,Et,Dt,null),wt>>=1,Mt>>=1}}else if(oe.length>0){if(Q&&Ut){const wt=Zt(oe[0]);n.texStorage2D(c.TEXTURE_2D,Bt,Pt,wt.width,wt.height)}for(let wt=0,Mt=oe.length;wt<Mt;wt++)Ct=oe[wt],Q?Rt&&n.texSubImage2D(c.TEXTURE_2D,wt,0,0,Et,Dt,Ct):n.texImage2D(c.TEXTURE_2D,wt,Pt,Et,Dt,Ct);A.generateMipmaps=!1}else if(Q){if(Ut){const wt=Zt(mt);n.texStorage2D(c.TEXTURE_2D,Bt,Pt,wt.width,wt.height)}Rt&&n.texSubImage2D(c.TEXTURE_2D,0,0,0,Et,Dt,mt)}else n.texImage2D(c.TEXTURE_2D,0,Pt,Et,Dt,mt);S(A)&&x(_t),At.__version=pt.version,A.onUpdate&&A.onUpdate(A)}I.__version=A.version}function dt(I,A,J){if(A.image.length!==6)return;const _t=gt(I,A),bt=A.source;n.bindTexture(c.TEXTURE_CUBE_MAP,I.__webglTexture,c.TEXTURE0+J);const pt=a.get(bt);if(bt.version!==pt.__version||_t===!0){n.activeTexture(c.TEXTURE0+J);const At=Ce.getPrimaries(Ce.workingColorSpace),xt=A.colorSpace===Ms?null:Ce.getPrimaries(A.colorSpace),Ot=A.colorSpace===Ms||At===xt?c.NONE:c.BROWSER_DEFAULT_WEBGL;c.pixelStorei(c.UNPACK_FLIP_Y_WEBGL,A.flipY),c.pixelStorei(c.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),c.pixelStorei(c.UNPACK_ALIGNMENT,A.unpackAlignment),c.pixelStorei(c.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ot);const zt=A.isCompressedTexture||A.image[0].isCompressedTexture,mt=A.image[0]&&A.image[0].isDataTexture,Et=[];for(let Mt=0;Mt<6;Mt++)!zt&&!mt?Et[Mt]=b(A.image[Mt],!0,r.maxCubemapSize):Et[Mt]=mt?A.image[Mt].image:A.image[Mt],Et[Mt]=Ee(A,Et[Mt]);const Dt=Et[0],Pt=o.convert(A.format,A.colorSpace),Ct=o.convert(A.type),oe=D(A.internalFormat,Pt,Ct,A.colorSpace),Q=A.isVideoTexture!==!0,Ut=pt.__version===void 0||_t===!0,Rt=bt.dataReady;let Bt=z(A,Dt);Y(c.TEXTURE_CUBE_MAP,A);let wt;if(zt){Q&&Ut&&n.texStorage2D(c.TEXTURE_CUBE_MAP,Bt,oe,Dt.width,Dt.height);for(let Mt=0;Mt<6;Mt++){wt=Et[Mt].mipmaps;for(let Nt=0;Nt<wt.length;Nt++){const re=wt[Nt];A.format!==Fi?Pt!==null?Q?Rt&&n.compressedTexSubImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Nt,0,0,re.width,re.height,Pt,re.data):n.compressedTexImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Nt,oe,re.width,re.height,0,re.data):ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Q?Rt&&n.texSubImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Nt,0,0,re.width,re.height,Pt,Ct,re.data):n.texImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Nt,oe,re.width,re.height,0,Pt,Ct,re.data)}}}else{if(wt=A.mipmaps,Q&&Ut){wt.length>0&&Bt++;const Mt=Zt(Et[0]);n.texStorage2D(c.TEXTURE_CUBE_MAP,Bt,oe,Mt.width,Mt.height)}for(let Mt=0;Mt<6;Mt++)if(mt){Q?Rt&&n.texSubImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,0,0,Et[Mt].width,Et[Mt].height,Pt,Ct,Et[Mt].data):n.texImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,oe,Et[Mt].width,Et[Mt].height,0,Pt,Ct,Et[Mt].data);for(let Nt=0;Nt<wt.length;Nt++){const He=wt[Nt].image[Mt].image;Q?Rt&&n.texSubImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Nt+1,0,0,He.width,He.height,Pt,Ct,He.data):n.texImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Nt+1,oe,He.width,He.height,0,Pt,Ct,He.data)}}else{Q?Rt&&n.texSubImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,0,0,Pt,Ct,Et[Mt]):n.texImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,oe,Pt,Ct,Et[Mt]);for(let Nt=0;Nt<wt.length;Nt++){const re=wt[Nt];Q?Rt&&n.texSubImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Nt+1,0,0,Pt,Ct,re.image[Mt]):n.texImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Nt+1,oe,Pt,Ct,re.image[Mt])}}}S(A)&&x(c.TEXTURE_CUBE_MAP),pt.__version=bt.version,A.onUpdate&&A.onUpdate(A)}I.__version=A.version}function Lt(I,A,J,_t,bt,pt){const At=o.convert(J.format,J.colorSpace),xt=o.convert(J.type),Ot=D(J.internalFormat,At,xt,J.colorSpace),zt=a.get(A),mt=a.get(J);if(mt.__renderTarget=A,!zt.__hasExternalTextures){const Et=Math.max(1,A.width>>pt),Dt=Math.max(1,A.height>>pt);bt===c.TEXTURE_3D||bt===c.TEXTURE_2D_ARRAY?n.texImage3D(bt,pt,Ot,Et,Dt,A.depth,0,At,xt,null):n.texImage2D(bt,pt,Ot,Et,Dt,0,At,xt,null)}n.bindFramebuffer(c.FRAMEBUFFER,I),Ke(A)?f.framebufferTexture2DMultisampleEXT(c.FRAMEBUFFER,_t,bt,mt.__webglTexture,0,W(A)):(bt===c.TEXTURE_2D||bt>=c.TEXTURE_CUBE_MAP_POSITIVE_X&&bt<=c.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&c.framebufferTexture2D(c.FRAMEBUFFER,_t,bt,mt.__webglTexture,pt),n.bindFramebuffer(c.FRAMEBUFFER,null)}function Ht(I,A,J){if(c.bindRenderbuffer(c.RENDERBUFFER,I),A.depthBuffer){const _t=A.depthTexture,bt=_t&&_t.isDepthTexture?_t.type:null,pt=C(A.stencilBuffer,bt),At=A.stencilBuffer?c.DEPTH_STENCIL_ATTACHMENT:c.DEPTH_ATTACHMENT;Ke(A)?f.renderbufferStorageMultisampleEXT(c.RENDERBUFFER,W(A),pt,A.width,A.height):J?c.renderbufferStorageMultisample(c.RENDERBUFFER,W(A),pt,A.width,A.height):c.renderbufferStorage(c.RENDERBUFFER,pt,A.width,A.height),c.framebufferRenderbuffer(c.FRAMEBUFFER,At,c.RENDERBUFFER,I)}else{const _t=A.textures;for(let bt=0;bt<_t.length;bt++){const pt=_t[bt],At=o.convert(pt.format,pt.colorSpace),xt=o.convert(pt.type),Ot=D(pt.internalFormat,At,xt,pt.colorSpace);Ke(A)?f.renderbufferStorageMultisampleEXT(c.RENDERBUFFER,W(A),Ot,A.width,A.height):J?c.renderbufferStorageMultisample(c.RENDERBUFFER,W(A),Ot,A.width,A.height):c.renderbufferStorage(c.RENDERBUFFER,Ot,A.width,A.height)}}c.bindRenderbuffer(c.RENDERBUFFER,null)}function qt(I,A,J){const _t=A.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(c.FRAMEBUFFER,I),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const bt=a.get(A.depthTexture);if(bt.__renderTarget=A,(!bt.__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),_t){if(bt.__webglInit===void 0&&(bt.__webglInit=!0,A.depthTexture.addEventListener("dispose",B)),bt.__webglTexture===void 0){bt.__webglTexture=c.createTexture(),n.bindTexture(c.TEXTURE_CUBE_MAP,bt.__webglTexture),Y(c.TEXTURE_CUBE_MAP,A.depthTexture);const zt=o.convert(A.depthTexture.format),mt=o.convert(A.depthTexture.type);let Et;A.depthTexture.format===Ha?Et=c.DEPTH_COMPONENT24:A.depthTexture.format===ar&&(Et=c.DEPTH24_STENCIL8);for(let Dt=0;Dt<6;Dt++)c.texImage2D(c.TEXTURE_CUBE_MAP_POSITIVE_X+Dt,0,Et,A.width,A.height,0,zt,mt,null)}}else q(A.depthTexture,0);const pt=bt.__webglTexture,At=W(A),xt=_t?c.TEXTURE_CUBE_MAP_POSITIVE_X+J:c.TEXTURE_2D,Ot=A.depthTexture.format===ar?c.DEPTH_STENCIL_ATTACHMENT:c.DEPTH_ATTACHMENT;if(A.depthTexture.format===Ha)Ke(A)?f.framebufferTexture2DMultisampleEXT(c.FRAMEBUFFER,Ot,xt,pt,0,At):c.framebufferTexture2D(c.FRAMEBUFFER,Ot,xt,pt,0);else if(A.depthTexture.format===ar)Ke(A)?f.framebufferTexture2DMultisampleEXT(c.FRAMEBUFFER,Ot,xt,pt,0,At):c.framebufferTexture2D(c.FRAMEBUFFER,Ot,xt,pt,0);else throw new Error("Unknown depthTexture format")}function ge(I){const A=a.get(I),J=I.isWebGLCubeRenderTarget===!0;if(A.__boundDepthTexture!==I.depthTexture){const _t=I.depthTexture;if(A.__depthDisposeCallback&&A.__depthDisposeCallback(),_t){const bt=()=>{delete A.__boundDepthTexture,delete A.__depthDisposeCallback,_t.removeEventListener("dispose",bt)};_t.addEventListener("dispose",bt),A.__depthDisposeCallback=bt}A.__boundDepthTexture=_t}if(I.depthTexture&&!A.__autoAllocateDepthBuffer)if(J)for(let _t=0;_t<6;_t++)qt(A.__webglFramebuffer[_t],I,_t);else{const _t=I.texture.mipmaps;_t&&_t.length>0?qt(A.__webglFramebuffer[0],I,0):qt(A.__webglFramebuffer,I,0)}else if(J){A.__webglDepthbuffer=[];for(let _t=0;_t<6;_t++)if(n.bindFramebuffer(c.FRAMEBUFFER,A.__webglFramebuffer[_t]),A.__webglDepthbuffer[_t]===void 0)A.__webglDepthbuffer[_t]=c.createRenderbuffer(),Ht(A.__webglDepthbuffer[_t],I,!1);else{const bt=I.stencilBuffer?c.DEPTH_STENCIL_ATTACHMENT:c.DEPTH_ATTACHMENT,pt=A.__webglDepthbuffer[_t];c.bindRenderbuffer(c.RENDERBUFFER,pt),c.framebufferRenderbuffer(c.FRAMEBUFFER,bt,c.RENDERBUFFER,pt)}}else{const _t=I.texture.mipmaps;if(_t&&_t.length>0?n.bindFramebuffer(c.FRAMEBUFFER,A.__webglFramebuffer[0]):n.bindFramebuffer(c.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer===void 0)A.__webglDepthbuffer=c.createRenderbuffer(),Ht(A.__webglDepthbuffer,I,!1);else{const bt=I.stencilBuffer?c.DEPTH_STENCIL_ATTACHMENT:c.DEPTH_ATTACHMENT,pt=A.__webglDepthbuffer;c.bindRenderbuffer(c.RENDERBUFFER,pt),c.framebufferRenderbuffer(c.FRAMEBUFFER,bt,c.RENDERBUFFER,pt)}}n.bindFramebuffer(c.FRAMEBUFFER,null)}function Ie(I,A,J){const _t=a.get(I);A!==void 0&&Lt(_t.__webglFramebuffer,I,I.texture,c.COLOR_ATTACHMENT0,c.TEXTURE_2D,0),J!==void 0&&ge(I)}function ve(I){const A=I.texture,J=a.get(I),_t=a.get(A);I.addEventListener("dispose",P);const bt=I.textures,pt=I.isWebGLCubeRenderTarget===!0,At=bt.length>1;if(At||(_t.__webglTexture===void 0&&(_t.__webglTexture=c.createTexture()),_t.__version=A.version,u.memory.textures++),pt){J.__webglFramebuffer=[];for(let xt=0;xt<6;xt++)if(A.mipmaps&&A.mipmaps.length>0){J.__webglFramebuffer[xt]=[];for(let Ot=0;Ot<A.mipmaps.length;Ot++)J.__webglFramebuffer[xt][Ot]=c.createFramebuffer()}else J.__webglFramebuffer[xt]=c.createFramebuffer()}else{if(A.mipmaps&&A.mipmaps.length>0){J.__webglFramebuffer=[];for(let xt=0;xt<A.mipmaps.length;xt++)J.__webglFramebuffer[xt]=c.createFramebuffer()}else J.__webglFramebuffer=c.createFramebuffer();if(At)for(let xt=0,Ot=bt.length;xt<Ot;xt++){const zt=a.get(bt[xt]);zt.__webglTexture===void 0&&(zt.__webglTexture=c.createTexture(),u.memory.textures++)}if(I.samples>0&&Ke(I)===!1){J.__webglMultisampledFramebuffer=c.createFramebuffer(),J.__webglColorRenderbuffer=[],n.bindFramebuffer(c.FRAMEBUFFER,J.__webglMultisampledFramebuffer);for(let xt=0;xt<bt.length;xt++){const Ot=bt[xt];J.__webglColorRenderbuffer[xt]=c.createRenderbuffer(),c.bindRenderbuffer(c.RENDERBUFFER,J.__webglColorRenderbuffer[xt]);const zt=o.convert(Ot.format,Ot.colorSpace),mt=o.convert(Ot.type),Et=D(Ot.internalFormat,zt,mt,Ot.colorSpace,I.isXRRenderTarget===!0),Dt=W(I);c.renderbufferStorageMultisample(c.RENDERBUFFER,Dt,Et,I.width,I.height),c.framebufferRenderbuffer(c.FRAMEBUFFER,c.COLOR_ATTACHMENT0+xt,c.RENDERBUFFER,J.__webglColorRenderbuffer[xt])}c.bindRenderbuffer(c.RENDERBUFFER,null),I.depthBuffer&&(J.__webglDepthRenderbuffer=c.createRenderbuffer(),Ht(J.__webglDepthRenderbuffer,I,!0)),n.bindFramebuffer(c.FRAMEBUFFER,null)}}if(pt){n.bindTexture(c.TEXTURE_CUBE_MAP,_t.__webglTexture),Y(c.TEXTURE_CUBE_MAP,A);for(let xt=0;xt<6;xt++)if(A.mipmaps&&A.mipmaps.length>0)for(let Ot=0;Ot<A.mipmaps.length;Ot++)Lt(J.__webglFramebuffer[xt][Ot],I,A,c.COLOR_ATTACHMENT0,c.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ot);else Lt(J.__webglFramebuffer[xt],I,A,c.COLOR_ATTACHMENT0,c.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0);S(A)&&x(c.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(At){for(let xt=0,Ot=bt.length;xt<Ot;xt++){const zt=bt[xt],mt=a.get(zt);let Et=c.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Et=I.isWebGL3DRenderTarget?c.TEXTURE_3D:c.TEXTURE_2D_ARRAY),n.bindTexture(Et,mt.__webglTexture),Y(Et,zt),Lt(J.__webglFramebuffer,I,zt,c.COLOR_ATTACHMENT0+xt,Et,0),S(zt)&&x(Et)}n.unbindTexture()}else{let xt=c.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(xt=I.isWebGL3DRenderTarget?c.TEXTURE_3D:c.TEXTURE_2D_ARRAY),n.bindTexture(xt,_t.__webglTexture),Y(xt,A),A.mipmaps&&A.mipmaps.length>0)for(let Ot=0;Ot<A.mipmaps.length;Ot++)Lt(J.__webglFramebuffer[Ot],I,A,c.COLOR_ATTACHMENT0,xt,Ot);else Lt(J.__webglFramebuffer,I,A,c.COLOR_ATTACHMENT0,xt,0);S(A)&&x(xt),n.unbindTexture()}I.depthBuffer&&ge(I)}function he(I){const A=I.textures;for(let J=0,_t=A.length;J<_t;J++){const bt=A[J];if(S(bt)){const pt=T(I),At=a.get(bt).__webglTexture;n.bindTexture(pt,At),x(pt),n.unbindTexture()}}}const Ae=[],se=[];function We(I){if(I.samples>0){if(Ke(I)===!1){const A=I.textures,J=I.width,_t=I.height;let bt=c.COLOR_BUFFER_BIT;const pt=I.stencilBuffer?c.DEPTH_STENCIL_ATTACHMENT:c.DEPTH_ATTACHMENT,At=a.get(I),xt=A.length>1;if(xt)for(let zt=0;zt<A.length;zt++)n.bindFramebuffer(c.FRAMEBUFFER,At.__webglMultisampledFramebuffer),c.framebufferRenderbuffer(c.FRAMEBUFFER,c.COLOR_ATTACHMENT0+zt,c.RENDERBUFFER,null),n.bindFramebuffer(c.FRAMEBUFFER,At.__webglFramebuffer),c.framebufferTexture2D(c.DRAW_FRAMEBUFFER,c.COLOR_ATTACHMENT0+zt,c.TEXTURE_2D,null,0);n.bindFramebuffer(c.READ_FRAMEBUFFER,At.__webglMultisampledFramebuffer);const Ot=I.texture.mipmaps;Ot&&Ot.length>0?n.bindFramebuffer(c.DRAW_FRAMEBUFFER,At.__webglFramebuffer[0]):n.bindFramebuffer(c.DRAW_FRAMEBUFFER,At.__webglFramebuffer);for(let zt=0;zt<A.length;zt++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(bt|=c.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(bt|=c.STENCIL_BUFFER_BIT)),xt){c.framebufferRenderbuffer(c.READ_FRAMEBUFFER,c.COLOR_ATTACHMENT0,c.RENDERBUFFER,At.__webglColorRenderbuffer[zt]);const mt=a.get(A[zt]).__webglTexture;c.framebufferTexture2D(c.DRAW_FRAMEBUFFER,c.COLOR_ATTACHMENT0,c.TEXTURE_2D,mt,0)}c.blitFramebuffer(0,0,J,_t,0,0,J,_t,bt,c.NEAREST),p===!0&&(Ae.length=0,se.length=0,Ae.push(c.COLOR_ATTACHMENT0+zt),I.depthBuffer&&I.resolveDepthBuffer===!1&&(Ae.push(pt),se.push(pt),c.invalidateFramebuffer(c.DRAW_FRAMEBUFFER,se)),c.invalidateFramebuffer(c.READ_FRAMEBUFFER,Ae))}if(n.bindFramebuffer(c.READ_FRAMEBUFFER,null),n.bindFramebuffer(c.DRAW_FRAMEBUFFER,null),xt)for(let zt=0;zt<A.length;zt++){n.bindFramebuffer(c.FRAMEBUFFER,At.__webglMultisampledFramebuffer),c.framebufferRenderbuffer(c.FRAMEBUFFER,c.COLOR_ATTACHMENT0+zt,c.RENDERBUFFER,At.__webglColorRenderbuffer[zt]);const mt=a.get(A[zt]).__webglTexture;n.bindFramebuffer(c.FRAMEBUFFER,At.__webglFramebuffer),c.framebufferTexture2D(c.DRAW_FRAMEBUFFER,c.COLOR_ATTACHMENT0+zt,c.TEXTURE_2D,mt,0)}n.bindFramebuffer(c.DRAW_FRAMEBUFFER,At.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&p){const A=I.stencilBuffer?c.DEPTH_STENCIL_ATTACHMENT:c.DEPTH_ATTACHMENT;c.invalidateFramebuffer(c.DRAW_FRAMEBUFFER,[A])}}}function W(I){return Math.min(r.maxSamples,I.samples)}function Ke(I){const A=a.get(I);return I.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function _e(I){const A=u.render.frame;g.get(I)!==A&&(g.set(I,A),I.update())}function Ee(I,A){const J=I.colorSpace,_t=I.format,bt=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||J!==po&&J!==Ms&&(Ce.getTransfer(J)===qe?(_t!==Fi||bt!==ui)&&ue("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Re("WebGLTextures: Unsupported texture color space:",J)),A}function Zt(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(h.width=I.naturalWidth||I.width,h.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(h.width=I.displayWidth,h.height=I.displayHeight):(h.width=I.width,h.height=I.height),h}this.allocateTextureUnit=H,this.resetTextureUnits=$,this.setTexture2D=q,this.setTexture2DArray=L,this.setTexture3D=V,this.setTextureCube=K,this.rebindTextures=Ie,this.setupRenderTarget=ve,this.updateRenderTargetMipmap=he,this.updateMultisampleRenderTarget=We,this.setupDepthRenderbuffer=ge,this.setupFrameBufferTexture=Lt,this.useMultisampledRTT=Ke,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function YC(c,t){function n(a,r=Ms){let o;const u=Ce.getTransfer(r);if(a===ui)return c.UNSIGNED_BYTE;if(a===zp)return c.UNSIGNED_SHORT_4_4_4_4;if(a===Pp)return c.UNSIGNED_SHORT_5_5_5_1;if(a===Cx)return c.UNSIGNED_INT_5_9_9_9_REV;if(a===Dx)return c.UNSIGNED_INT_10F_11F_11F_REV;if(a===wx)return c.BYTE;if(a===Rx)return c.SHORT;if(a===Cl)return c.UNSIGNED_SHORT;if(a===Op)return c.INT;if(a===ia)return c.UNSIGNED_INT;if(a===Ji)return c.FLOAT;if(a===Ia)return c.HALF_FLOAT;if(a===Nx)return c.ALPHA;if(a===Ux)return c.RGB;if(a===Fi)return c.RGBA;if(a===Ha)return c.DEPTH_COMPONENT;if(a===ar)return c.DEPTH_STENCIL;if(a===Lx)return c.RED;if(a===Bp)return c.RED_INTEGER;if(a===ho)return c.RG;if(a===Fp)return c.RG_INTEGER;if(a===Ip)return c.RGBA_INTEGER;if(a===Eu||a===bu||a===Tu||a===Au)if(u===qe)if(o=t.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(a===Eu)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===bu)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===Tu)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===Au)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=t.get("WEBGL_compressed_texture_s3tc"),o!==null){if(a===Eu)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===bu)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===Tu)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===Au)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===Yd||a===jd||a===Zd||a===Kd)if(o=t.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(a===Yd)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===jd)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===Zd)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===Kd)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===Qd||a===Jd||a===$d||a===tp||a===ep||a===np||a===ip)if(o=t.get("WEBGL_compressed_texture_etc"),o!==null){if(a===Qd||a===Jd)return u===qe?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(a===$d)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC;if(a===tp)return o.COMPRESSED_R11_EAC;if(a===ep)return o.COMPRESSED_SIGNED_R11_EAC;if(a===np)return o.COMPRESSED_RG11_EAC;if(a===ip)return o.COMPRESSED_SIGNED_RG11_EAC}else return null;if(a===ap||a===sp||a===rp||a===op||a===lp||a===cp||a===up||a===fp||a===hp||a===dp||a===pp||a===mp||a===gp||a===vp)if(o=t.get("WEBGL_compressed_texture_astc"),o!==null){if(a===ap)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===sp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===rp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===op)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===lp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===cp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===up)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===fp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===hp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===dp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===pp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===mp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===gp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===vp)return u===qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===_p||a===xp||a===yp)if(o=t.get("EXT_texture_compression_bptc"),o!==null){if(a===_p)return u===qe?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===xp)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===yp)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===Sp||a===Mp||a===Ep||a===bp)if(o=t.get("EXT_texture_compression_rgtc"),o!==null){if(a===Sp)return o.COMPRESSED_RED_RGTC1_EXT;if(a===Mp)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===Ep)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===bp)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===Dl?c.UNSIGNED_INT_24_8:c[a]!==void 0?c[a]:null}return{convert:n}}const jC=`
void main() {
